    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="image">
                    <img ng-repeat="d_image in LoadEventDefaultImage" src=".././upload/event_default_images/{{d_image.banner_image}}"  alt="Default image" class="img-responsive img-thumbnail" style="max-width:185px; max-height:160px">
                </div>
            </div>
...
<div class="modal fade" id="thumb_image" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="image">
                    <img src="assets/img/background/background-5.png" alt="img" class="img-responsive img-thumbnail" style="max-width:185px; max-height:160px">
                    <img src="assets/img/background/background-5.png" alt="img" class="img-responsive img-thumbnail" style="max-width:185px; max-height:160px">
                    <img src="assets/img/background/background-5.png" alt="img" class="img-responsive img-thumbnail" style="max-width:185px; max-height:160px">
                </div>
            </div>
