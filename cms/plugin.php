    ...
    public function headCss($array = array()) {
        if (!empty($array)) {
            if (in_array("home", $array)) {
                ...
                $css .= $this->notificationCss();
                return $css;
            } elseif(in_array("how_it_works", $array)) {
                //how_it_works page css
                $css = '';
                $css .= $this->SiteBasicCss();
                $css .= $this->howItWorksCss();
                $css .= $this->notificationCss();
                $css .= $this->searchPanel();
                return $css;
...
//      pivate CSS & JS binding start
    ...
    private function SiteBasicCss() {
        ...
        $basiccss .=$this->searchPanel();
        $basiccss .=$this->loaderCss();
...
//      page CSS file include start 
    ...
    private function howItWorksCss() {
        $howItWorksCss = '';
        $howItWorksCss .= '<link rel="stylesheet" href=" ' . $this->baseUrl("assets/css/howItWorks.css") . ' ">';
        $howItWorksCss .= '<link rel="stylesheet" href=" ' . $this->baseUrl("plugins/lightbox/dist/css/lightbox.min.css") . ' ">';
        return $howItWorksCss;
    }
...
//      page JS file include start 
    ...
    private function coreJs() {
        ...
        <script src="' . $this->baseUrl("assets/js/nouislider.min.js") . '"></script>
    ...
    private function cardJs() {
        ...
        var script_arr = ["' . $this->baseUrl("plugins/x-hipster-as-f-cards-v1.1/assets/js/hipster-cards.js") . '",
            "' . $this->baseUrl("plugins/Waves-master/dist/waves.min.js") . '",
            "' . $this->baseUrl("plugins/odometer-master/odometer.min.js") . '",
            "' . $this->baseUrl("plugins/WOW-master/dist/wow.min.js") . '"];
        ...
        /* Backups<script src="' . $this->baseUrl("plugins/x-hipster-as-f-cards-v1.1/assets/js/hipster-cards.js") . '" type="text/javascript"></script>
...
//      Base URL start 
    ...
    public function baseUrl($suffix = '') {
        ...
        if ($_SERVER['HTTP_HOST'] == "localhost") {
            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchaiorg/ticketchai_aj/tc-merchant-template/";
            ...
            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchaiorg/tc-merchant-template/";
        } else {
            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchaiorg/tc-merchant-template/";
        }
    ...
    public function LbaseUrl($suffix = '') {
        ...
        //$web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "Dropbox/odesk/pos/";
        if ($_SERVER['HTTP_HOST'] == "localhost") {
            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchaiorg/ticketchai_aj/";
        } elseif ($_SERVER['HTTP_HOST'] == "192.168.1.48") {
            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchaiorg/ticketchai_aj/";
        } elseif ($_SERVER['HTTP_HOST'] == "ticketchai.com" || $_SERVER['HTTP_HOST'] == "http://ticketchai.com" || $_SERVER['HTTP_HOST'] == "http://ticketchai.com/" || $_SERVER['HTTP_HOST'] == "https://ticketchai.com" || $_SERVER['HTTP_HOST'] == "https://ticketchai.com/" || $_SERVER['HTTP_HOST'] == "www.ticketchai.com/" || $_SERVER['HTTP_HOST'] == "www.ticketchai.com") {
    ...
    public function siteUrl($suffix = '') {
        ...
        if ($_SERVER['HTTP_HOST'] == "localhost") {
            ...
            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchaiorg/";
        } elseif ($_SERVER['HTTP_HOST'] == "ticketchai.com" || $_SERVER['HTTP_HOST'] == "https://ticketchai.org" || $_SERVER['HTTP_HOST'] == "http://ticketchai.com/") {
            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchaiorg/";
        } else {
            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchaiorg/";
        }
...
//     public function merchant_baseUrl($suffix = '') {
//        $protocol = strpos($_SERVER['SERVER_SIGNATURE'], '443') !== false ? 'https://' : 'http://';
////$web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "Dropbox/odesk/pos/";
//        if ($_SERVER['HTTP_HOST'] == "localhost") {
...
//            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchai_aj/merchant-dashboard/";
//        } 
//         elseif ($_SERVER['HTTP_HOST'] == "ticketchai.org") {
//            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "merchant-dashboard/";
//        }else {
//            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "merchant-dashboard/";
//        }
//
...
//      Base URL end 
    ...
    public function baseUrlAngular($suffix = '') {
        ...
        //$web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "Dropbox/odesk/pos/";
        if ($_SERVER['HTTP_HOST'] == "localhost") {
            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchaiorg/ticketchai_aj/angularJs/";
        } elseif ($_SERVER['HTTP_HOST'] == "192.168.1.48") {
            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchaiorg/ticketchai_aj/angularJs/";
        } else {
            $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "ticketchaiorg/angularJs/";
        }
    ...
    public function angularJs($array = array()) {
        if (!empty($array)) {
            if (in_array("index", $array)) {
                ...
                return $js;
            } elseif (in_array("tag_events_angular", $array)) {
                $js = '';
                $js .=$this->coreAngular();
                $js .=$this->tag_events();
                return $js;
                ...
                $js .=$this->notificationJs();
                return $js;
            } elseif (in_array("bkash_angular", $array)) {
                $js = '';
                $js .=$this->coreAngular();
                $js .='<script src="' . $this->baseUrlAngular("fontEnd/app.js") . '"></script>';
               // $js.='<script src="' . $this->baseUrlAngular("fontEnd/scripts/navbarController.js") . '"></script>';
                $js .='<script src="' . $this->baseUrlAngular("fontEnd/scripts/bkashController.js") . '"></script>';
                $js .=$this->notificationJs();
                return $js;
...
//    }
    ...
    private function tag_events() {
        $tagAngular = '';
        $tagAngular .= '<script src="' . $this->baseUrlAngular("fontEnd/app.js") . '"></script>';
        $tagAngular .= '<script src="' . $this->baseUrlAngular("fontEnd/scripts/tag_wise_eventsController.js") . '"></script>';
