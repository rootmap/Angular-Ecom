...
<?php endif; ?>
    ...
    <li class="hasSubmenu">
        ...
        <ul id="subscription" class="collapse ">
            ...
            <li id="subscriptiondataList"><a href="<?php echo baseUrl('admin/contact_us/subscription_list.php'); ?>"><i class="fa fa-phone"></i><span>Subscription list</span></a></li> 
            ...
            <li id="subscriptioncustomerList"><a href="<?php echo baseUrl('admin/contact_us/subscription_customer_list.php'); ?>"><i class="fa fa-phone"></i><span>Subscription customer list</span></a></li> 
        </ul>
    </li>