...
<html>
    ...
    <body class="">
        ...
        <div id="content">
            <h3 class="bg-white content-heading border-bottom strong">Movie Gallery List</h3>
            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                    <?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/add_movie_gallery_index.php') ?>">
                            <span class="k-icon k-add"></span>
                            Add Movie Gallery Image
                        </a>
                    <?php endif; ?>
                    <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/movie_gallery_list.php'); ?>">
...
<?php if (checkPermission('gallery', 'update', getSession('admin_type'))): ?>
                    <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/gallery/add_movie_gallery_index.php'); ?>?id=#= id #"><span class="k-icon k-edit"></span>Edit</a>
<?php endif; ?>               
                ...
                function deleteClick(imageID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/gallery/movie_gallery_list_controller.php",
                            data: {IG_id: imageID},
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    ...
                    jQuery("#grid").kendoGrid({
                        ...
                        groupable: true,
                        columns: [
                            {field: "id", title: "GID", width: "150px"},
                            {field: "movie_id", title: "Movie ID", width: "150px"},
                            {field: "movie_name", title: "Movie Name", width: "150px"},
                            {field: "image",
                                title: "Image Name",
                                width: "90px",
                                template: "<img src='<?php echo baseUrl("upload/image_file/original/") ?>#=image#' height='50' width='110'/>"
                            },
