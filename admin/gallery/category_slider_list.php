        ...
        <div id="content">
            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                    <?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/add_new_slider_image.php') ?>">
                            <span class="k-icon k-add"></span>
                            Add new slider Image
                        </a>
                    <?php endif; ?>
                    <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/event/category_slider_list.php'); ?>">
                            <span class="k-icon k-i-arrowhead-w"></span>
                            Go Back Category slider
                        </a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <script id="edit_gallery" type="text/x-kendo-template">
                <?php if (checkPermission('gallery', 'update', getSession('admin_type'))): ?>
                    <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/gallery/add_new_slider_image.php'); ?>?id=#= id #"><span class="k-icon k-edit"></span>Edit</a>
                <?php endif; ?>
                ...
                function deleteClick(imageID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/gallery/category_slider_list_controller.php",
                            data: {IG_id: imageID},
                ...
                jQuery(document).ready(function () {
                    ...
                    jQuery("#grid").kendoGrid({
                        ...
                        columns: [
                            ...
                            {field: "category_title", title: "Catagory Name", width: "150px"},
                            //{field: "movie", title: "Movie Name", width: "150px"},
                            {field: "image",
                                title: "Image Name",
                                width: "90px",
