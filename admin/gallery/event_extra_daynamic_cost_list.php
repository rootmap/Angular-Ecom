            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                    <?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/event_extra_dynamic_cost.php') ?>">
                            <span class="k-icon k-add"></span>
                            Add New Extra Dynamic Cost For Event
                        </a>
                    <?php endif; ?>
...
<?php endif; ?>
                ...
                function deleteClick(imageID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/gallery/event_extra_dynamic_cost_list.php",
                            data: {IG_id: imageID},
    ...
    <script type="text/javascript">
        $("#eventextradynamiccostlist").addClass("active");
        $("#eventextradynamiccostlist").parent().parent().addClass("active");
        $("#eventextradynamiccostlist").parent().addClass("in");
    </script>
