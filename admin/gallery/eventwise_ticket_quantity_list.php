...
<html>
    ...
    <body class="">
        ...
        <div id="content">
            <h3 class="bg-white content-heading border-bottom strong">Event wise ticket quantity</h3>
            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                    <?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/eventwise_ticket_quantity.php') ?>">
                            <span class="k-icon k-add"></span>
                            Add new Event wise ticket quantity
                        </a>
                    <?php endif; ?>
                    <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/eventwise_ticket_quantity_list.php' ); ?>">
                            <span class="k-icon k-i-arrowhead-w"></span>
                            Go Back Event wise ticket quantity
                        </a>
                    <?php endif; ?>
                </div>
            </div>
...
<?php if (checkPermission('gallery', 'update', getSession('admin_type'))): ?>
                    <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/gallery/eventwise_ticket_quantity.php'); ?>?id=#= id #"><span class="k-icon k-edit"></span>Edit</a>
<?php endif; ?>
                ...
                function deleteClick(imageID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/gallery/eventwise_ticket_quantity_controller.php",
                            data: {IG_id: imageID},
                ...
                jQuery(document).ready(function () {
                    ...
                    jQuery("#grid").kendoGrid({
                        ...
                        columns: [
                            ...
                            //{field: "event_name", title: "Event Name", width: "150px"},
                            {field: " ticket_quantity", title: "User Quantity", width: "150px"},
