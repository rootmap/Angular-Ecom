...
//}
$arrEvents = array();
$get_events = "SELECT event_id,event_title FROM events ORDER BY event_title ASC";
...
if (isset($_POST["btnEditGallery"])) {
    ...
    $run_eedc_array_sql = "UPDATE event_online_charge SET ".$insert_eedc_array." WHERE id='".$id."'";
    ...
    if (!$result) {
        ...
        $msg = "Dynamic Online Charge Updated successfully";
        $link = "event_online_charge_list.php?msg=" . base64_encode($msg);
        redirect($link);
    }
    // Video link save end
...
if (isset($_POST["btnCreateGallery"])) {
    ...
    $run_eedc_array_sql = "INSERT INTO event_online_charge SET $insert_eedc_array";
    $result = mysqli_query($con, $run_eedc_array_sql);
    ...
    if (!$result) {
        ...
        $msg = "Dynamic Online Charge saved successfully";
        $link = "event_online_charge_list.php?msg=" . base64_encode($msg);
        redirect($link);
    }
    // Video link save end
...
if (isset($_GET['id'])) {
    $editarray = array();
    $sqledit = "Select * FROM event_online_charge WHERE id='" . $_GET['id'] . "'";
                            ...
                            <div class="widget-body">
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="itemTitle">Event Online Charge Title</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="itemDescription">Event Charge Cost</label>
                            ...
                            <div class="widget-body">
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="itemTitle">Event Charge Title</label>
