        ...
        <div id="content">
            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                    <?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/recent_post_content.php') ?>">
                            <span class="k-icon k-add"></span>
                            Add recent Post
                        </a>
                    <?php endif; ?>
                    <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/recent_post_list.php'); ?>">
                            <span class="k-icon k-i-arrowhead-w"></span>
                            Go Back recent post List
                        </a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <script id="edit_gallery" type="text/x-kendo-template">
                <?php if (checkPermission('gallery', 'update', getSession('admin_type'))): ?>
                    <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/gallery/recent_post_content.php'); ?>?id=#= id #"><span class="k-icon k-edit"></span>Edit</a>
                <?php endif; ?>
                ...
                function deleteClick(imageID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/gallery/recent_post_content.php",
                            data: {IG_id: imageID},
                ...
                jQuery(document).ready(function () {
                    ...
                    jQuery("#grid").kendoGrid({
                        ...
                        columns: [
                            ...
                            {field: "post_title", title: "Post Title", width: "150px"},
                            {field: "post_content", title: "Post Content", width: "150px"},
                            {field: "post_image", title: "Post Image", width: "150px"},
                            {
