            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                    <?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/index.php') ?>">
...
<?php endif; ?>
                ...
                function deleteClick(imageID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/gallery/gallery_list.php",
                            data: {IG_id: imageID},
            ...
            <?php if (checkPermission('gallery', 'read', getSession('admin_type'))): ?>
                <div id="videolist" style="margin-left: 10px;"></div>
            <?php else : ?>
                ...
                function deleteVideoClick(videoID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/gallery/video_list.php",
                            data: {VG_id: videoID},
                            success: function (result) {
