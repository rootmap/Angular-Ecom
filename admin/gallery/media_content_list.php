...
<html>
    ...
    <body class="">
        ...
        <div id="content">
            <h3 class="bg-white content-heading border-bottom strong">Media Content List</h3>
            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                    <?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/add_media_content.php') ?>">
                            <span class="k-icon k-add"></span>
                            Add Media Content
                        </a>
                    <?php endif; ?>
                    <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/media_content_list.php'); ?>">
                            <span class="k-icon k-i-arrowhead-w"></span>
                            Go Back Media Content List
                        </a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <script id="edit_gallery" type="text/x-kendo-template">
                <?php if (checkPermission('gallery', 'update', getSession('admin_type'))): ?>
                    <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/gallery/add_media_content.php'); ?>?id=#= id #"><span class="k-icon k-edit"></span>Edit</a>
                <?php endif; ?>
                ...
                function deleteClick(imageID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/gallery/add_media_content.php",
                            data: {IG_id: imageID},
                ...
                jQuery(document).ready(function () {
                        ...
                        schema: {
                            ...
                            model: {
                                ...
                                fields: {
                                    ...
                                    media_publish_date: {type: "string"},
                    ...
                    jQuery("#grid").kendoGrid({
                        ...
                        columns: [
                            ...
                            {field: "media_title", title: "Media Title", width: "150px"},
                            {field: "media_content", title: "Media Content", width: "150px"},
                            {field: "media_publish_date", title: "Media Publish Date", width: "150px"},
                            {field: "media_image", title: "Media Image", width: "150px"},
                            {
