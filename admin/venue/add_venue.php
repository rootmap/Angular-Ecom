...
if (isset($_POST['venue_title'])) {
    ...
    $insert_VenueArray = '';
    $insert_VenueArray .= ' venue_event_id = "' . $event_id . '"';
    ...
    if (!$result) {
        ...
        $msg = "Venue saved successfully for '$event_title'";
        $link = "event_venue_list.php?msg=" . base64_encode($msg) . "&" . $_SERVER['QUERY_STRING'];
        redirect($link);
    }
}
?>
...
<html>
    ...
    <body class="">
        ...
        <div id="content"><h3 class="bg-white content-heading border-bottom strong">Add Venue For <?php echo $event_title; ?></h3>
                        ...
                        <div class="widget-body">
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="">is one day event?</label>
                                        <div class="col-md-7">
