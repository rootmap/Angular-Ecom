...
<html>
    ...
    <body class="">
        ...
        <div id="content">
            <h3 class="bg-white content-heading border-bottom strong">Merchant-wise Event List</h3>
            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <?php if (checkPermission('clients', 'create', getSession('admin_type'))): ?>
                    <div class="k-toolbar k-grid-toolbar">
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/merchant_wise_event/add_merchant_wise_event.php'); ?>">
                            <span class="k-icon k-add"></span>
                            Add Merchant-wise Event
                        </a>
                    </div>
                <?php endif; ?>
            </div>
...
<?php /* if (checkPermission('clients', 'update', getSession('admin_type'))):   ?>
  <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/merchant_wise_event/edit_merchant_wise_event.php'); ?>?id=#= id#"><span class="k-icon k-edit"></span>Edit</a>
  <?php endif; */ ?>
...
<?php endif; ?>
            ...
            <script type="text/javascript">
                function deleteClick(MerchantID) {
                    var c = confirm("Do you want to delete?");
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/merchant_wise_event/merchant_wise_event_list.php",
                            data: {id: MerchantID},
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    ...
                    jQuery("#grid").kendoGrid({
                        ...
                        groupable: true,
                        columns: [
                            {field: "merchant_name", title: "Merchant Name", width: "150px"},
