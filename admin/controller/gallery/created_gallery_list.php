...
if ($verb == "GET") {
    ...
    $arr = array();
    $get_sql = "SELECT event_image_gallery.IG_id, event_image_gallery.IG_title, event_image_gallery.IG_image_name, event_image_gallery.IG_event_id, events.event_title,events.event_id FROM event_image_gallery LEFT JOIN events ON event_image_gallery.IG_event_id = events.event_id WHERE event_image_gallery.IG_event_id = $event_id ORDER BY event_image_gallery.IG_id DESC";
