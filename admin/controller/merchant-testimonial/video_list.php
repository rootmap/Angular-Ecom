...
if ($verb == "GET") {
    $arr = array();
    $get_sql = "SELECT event_video_gallery.VG_id, event_video_gallery.VG_title, event_video_gallery.VG_video_link, event_video_gallery.VG_event_id, events.event_id, events.event_title AS VG_event_title FROM event_video_gallery LEFT JOIN events ON event_video_gallery.VG_event_id = events.event_id order by event_video_gallery.VG_id DESC";
