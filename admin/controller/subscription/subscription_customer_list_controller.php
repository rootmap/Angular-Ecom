...
if ($verb == "GET") {
    ...
    $arrayContact = array();
    $get_sql = "SELECT * FROM subscribe_customer_list";
...
if ($verb == "POST") {
    ...
    $sqlClientImage = "select image from subscribe_customer_list where id = $id";
    ...
    $delete_sql = "DELETE FROM subscribe_customer_list WHERE id = '" . $id . "'";
