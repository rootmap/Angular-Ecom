...
<html>
    ...
    <body class="">
        ...
        <div id="content">
            ...
            <h3 class="bg-white content-heading border-bottom strong">Site Multiple Times Purchase Customer List</h3>
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    var dataSource = new kendo.data.DataSource({
                        ...
                        transport: {
                            read: {
                                url: "../controller/customer/return.php",
                                type: "GET"
                            },
                            destroy: {
                                url: "../controller/customer/return.php",
                    ...
                    jQuery("#export-grid").click(function (e) {
                        ...
                        JSONToCSVConvertor(json_data, "Purchase Multiple Times Customer List", true);
                    ...
                    function JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
                        ...
                        var fileName = "purchase_multiple_times_customer_list_";
    ...
    <script type="text/javascript">
        $("#purchase_multi_customer_list").addClass("active");
        $("#purchase_multi_customer_list").parent().parent().addClass("active");
        $("#purchase_multi_customer_list").parent().addClass("in");
    </script>
