...
<html>
    ...
    <body class="">
        ...
        <div id="content">
            ...
            <h3 class="bg-white content-heading border-bottom strong">User List - Event Wise</h3>
                ...
                <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>   
                    <div class="k-toolbar k-grid-toolbar">
                        ...
                        <select name="event_id" style="width: 400px;">
                            ...
                            ?>
                            <option <?php if(isset($_GET['event_id'])){ if($listv['event_id']==$_GET['event_id']){ ?> selected="selected" <?php }  } ?> value="<?php echo $listv['event_id']; ?>"><?php echo $listv['event_title']; ?></option>
                            <?php endwhile; ?>
                        </select>
                        </label>
                    </div>
...
<?php endif; ?>
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    var dataSource = new kendo.data.DataSource({
                        ...
                        transport: {
                            read: {
                                url: "../controller/customer/user_list.php<?php if(isset($_GET['event_id'])){ echo "?event_id=".$_GET['event_id']; } ?>",
                                type: "GET"
                            },
                            destroy: {
                    ...
                    <?php if(isset($_GET['event_id'])){ 
                        ...
                        $evt="For Event - ".$fetna['event_title'];
                    }else{ $evt=""; } ?>
                    ...
                    jQuery("#export-grid").click(function (e) {
                        ...
                        JSONToCSVConvertor(json_data, "User List <?php echo $evt; ?>", true);
    ...
    <script type="text/javascript">
        $("#eventwisecustomerlist").addClass("active");
        $("#eventwisecustomerlist").parent().parent().addClass("active");
        $("#eventwisecustomerlist").parent().addClass("in");
        
        $(document).ready(function(){
            $('select[name=event_id]').change(function(){
                var getval=$(this).val();
                window.location.replace("./user_list_event_wise.php?event_id="+getval);
                //console.log(getval);
            });
        });
