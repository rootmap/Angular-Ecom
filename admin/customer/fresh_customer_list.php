...
<html>
    ...
    <body class="">
        ...
        <div id="content">
            ...
            <h3 class="bg-white content-heading border-bottom strong">Site No-Purchase Customer List</h3>
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    var dataSource = new kendo.data.DataSource({
                        ...
                        transport: {
                            read: {
                                url: "../controller/customer/fresh_total.php",
                                type: "GET"
                            },
                            destroy: {
                                url: "../controller/customer/fresh_total.php",
                    ...
                    jQuery("#export-grid").click(function (e) {
                        ...
                        JSONToCSVConvertor(json_data, "No Purchase Customer List", true);
                    ...
                    function JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
                        ...
                        var fileName = "no_purchase_customer_list_";
    ...
    <script type="text/javascript">
        $("#customernopurchaselist").addClass("active");
        $("#customernopurchaselist").parent().parent().addClass("active");
        $("#customernopurchaselist").parent().addClass("in");
    </script>
