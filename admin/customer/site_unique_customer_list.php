...
<html>
    ...
    <body class="">
        ...
        <div id="content">
            ...
            <h3 class="bg-white content-heading border-bottom strong">Site Unique Customer List</h3>
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    var dataSource = new kendo.data.DataSource({
                        ...
                        transport: {
                            read: {
                                url: "../controller/customer/unique_customer.php",
                                type: "GET"
                            },
                            destroy: {
                                url: "../controller/customer/unique_customer.php",
                    ...
                    jQuery("#export-grid").click(function (e) {
                        ...
                        JSONToCSVConvertor(json_data, "All Unique Customer List", true);
                    ...
                    function JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
                        ...
                        var fileName = "all_unique_customer_list_";
    ...
    <script type="text/javascript">
        $("#customeruniquelist").addClass("active");
        $("#customeruniquelist").parent().parent().addClass("active");
        $("#customeruniquelist").parent().addClass("in");
    </script>
