...
<html>
    ...
    <body class="">
        ...
        <div id="content">
            ...
            <h3 class="bg-white content-heading border-bottom strong">Site Purchase Customer List</h3>
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    var dataSource = new kendo.data.DataSource({
                        ...
                        transport: {
                            read: {
                                url: "../controller/customer/return_onece.php",
                                type: "GET"
                            },
                            destroy: {
                                url: "../controller/customer/return_onece.php",
                    ...
                    jQuery("#export-grid").click(function (e) {
                        ...
                        JSONToCSVConvertor(json_data, "Purchase Customer List", true);
                    ...
                    function JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
                        ...
                        var fileName = "purchase_customer_list_";
    ...
    <script type="text/javascript">
        $("#customerpurchaselist").addClass("active");
        $("#customerpurchaselist").parent().parent().addClass("active");
        $("#customerpurchaselist").parent().addClass("in");
    </script>
