...
<html>
    ...
    <body class="">
        ...
        <div id="content">
            <h3 class="bg-white content-heading border-bottom strong">Movie order list</h3>
            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                      <?php if (checkPermission('gallery', 'create', getSession('admin_type'))):               ?>
                          <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/orders/movie_order.php#')               ?>">
                              <span class="k-icon k-add"></span>
                              Add new Movie Order 
                          </a>
                    <?php  endif; ?>
                    <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/orders/movie_order_list.php'); ?>">
                            <span class="k-icon k-i-arrowhead-w"></span>
                            Go Back movie order list
                        </a>
                    <?php endif; ?>
                </div>
            </div>
...
<?php if (checkPermission('gallery', 'update', getSession('admin_type'))): ?>
                    <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/orders/movie_order.php'); ?>?id=#=id #"><span class="k-icon k-edit"></span>Edit</a>
<?php endif; ?>
                ...
                function deleteClick(imageID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/order/movie_order_list_controller.php",
                            data: {IG_id: imageID},
                ...
                jQuery(document).ready(function () {
                        ...
                        schema: {
                            ...
                            model: {
                                ...
                                fields: {
                                    ...
                                    verified_order_id: {type: "string"},
                                    movie_id: {type: "string"},
                                    movie_name: {type: "string"},
                                    seat: {type: "string"},
                                    seat_number: {type: "string"},
                                    seat_unit_price: {type: "string"},
                    ...
                    jQuery("#grid").kendoGrid({
                        ...
                        columns: [
                            ...
                            {field: "event_title", title: "Event Name", width: "150px"},
                            {field: "verified_order_id", title: "Verified Order ID", width: "150px"},
                            {field: "movie_id", title: "Movie ID", width: "150px"},
                            {field: "movie_name", title: "Movie Name", width: "150px"},
                            {field: "seat", title: "Seat", width: "150px"},
                            {field: "seat_number", title: "Seat Number", width: "150px"},
                            {field: "seat_unit_price", title: "Seat Unit Price", width: "150px"},
                            {field: "seat_type", title: "Seat Type", width: "150px"},
                            {field: "request_date", title: "Request Date", width: "150px"},
                            {field: "fullname", title: "Full Name", width: "150px"},
                            {field: "email", title: "Email", width: "150px"},
                            {field: "mobile", title: "Mobile", width: "150px"},
                            {field: "sex", title: "Gender", width: "150px"},
                            {field: "datetime", title: "Record Added", width: "150px"},
                            {
