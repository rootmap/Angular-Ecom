...
if (isset($_POST["btnSave"])) {
    ...
    if (empty($announcement_title)) {
        ...
        $check_announce_sql = "SELECT * FROM announcements WHERE announcement_title = '$announcement_title'";
        ...
        if ($announce_count >= 1) {
            ...
            $insert_query = '';
            $insert_query .=' announcement_title = "' . $announcement_title . '"';
            $insert_query .=', announcement_short_desc = "' . $announcement_short_desc . '"';
            $insert_query .=', announcement_long_desc = "' . $announcement_long_desc . '"';
            if (isset($announcement_status)) {
                $insert_query .=', announcement_status = "' . $announcement_status . '"';
            }
            $insert_query .=', announcement_created_on ="' . $announcement_created_on . '"';
            $insert_query .=', announcement_created_by ="' . $announcement_created_by . '"';

            $run_insert_query = "INSERT INTO announcements SET $insert_query";
