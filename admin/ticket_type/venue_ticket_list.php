            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                    <?php if (checkPermission('ticket_type', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/ticket_type/add_ticket_type.php?venue_id=' . $venue_id . '&event_id=' . $event_id); ?>">
...
<?php if (checkPermission('ticket_type', 'update', getSession('admin_type'))): ?>
                    <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/ticket_type/edit_ticket_type.php'); ?>?TT_id=#= TT_id #"><span class="k-icon k-edit"></span>Edit</a>
<?php endif; ?>
                ...
                function deleteClick(TT_ID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/ticket_type/venue_ticket_list.php",
                            data: {TT_id: TT_ID},
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    var dataSource = new kendo.data.DataSource({
                        ...
                        transport: {
                            read: {
                                url: "../controller/ticket_type/venue_ticket_list.php?venue_id=<?php echo $venue_id; ?>&event_id=<?php echo $event_id; ?>",
                                type: "GET"
                            },
                            destroy: {
                                url: "../controller/ticket_type/venue_ticket_list.php",
                    ...
                    jQuery("#grid").kendoGrid({
                        ...
                        columns: [
                            ...
                            {field: "TT_current_price", title: "Current Price", width: "120px"},
                            {field: "TT_old_price", title: "Old Price", width: "120px"},
                            {field: "TT_ticket_quantity", title: "Total Ticket", width: "120px"},
