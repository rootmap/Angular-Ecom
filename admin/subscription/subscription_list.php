    ...
    <body class="">
        ...
        <div id="content">
            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                   <!-- <?php //if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                    ...
                    <?php //endif; ?> -->
                    <?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/contact_us/subscription.php') ?>">
                            <span class="k-icon k-add"></span>
                            Add New subscription
                        </a>
                    <?php endif; ?>
                    <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/subscription/subscription_list.php'); ?>">
                            <span class="k-icon k-i-arrowhead-w"></span>
                            Go Back Subscription List
                        </a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <?php if (checkPermission('gallery', 'update', getSession('admin_type'))): ?>
                                <a class="k-button k-button-icontext k-grid-check" onclick="javascript:Subscribe(#= id #);"><span class="k-icon k-check"></span>Subscribe Email</a>
            <?php endif; ?>    
            <?php if (checkPermission('gallery', 'update', getSession('admin_type'))): ?>
                                <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/contact_us/subscription.php'); ?>?id=#=id #&image_id=#= id #"><span class="k-icon k-edit"></span>Edit</a>
            <?php endif; ?>
                ...
                function deleteClick(imageID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/subscription/subscription_list_controller.php",
                            data: {id: imageID},
                ...
                jQuery(document).ready(function () {
                    ...
                    jQuery("#grid").kendoGrid({
                        ...
                        columns: [
                            ...
                            {field: "content", title: "Content", width: "150px"},
                            {field: "head", title: "Title", width: "150px"},
                            {field: "image", title: "Image", width: "150px"},
                           // {field: "full_name", title: "Email subscription list", width: "150px"},
                            //{field: "phone_number", title: "Action", width: "150px"},
                            {field: "date", title: "Added", width: "90px"},
                            {
                                title: "Email subscription list", width: "380px",
