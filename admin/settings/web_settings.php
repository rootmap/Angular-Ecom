...
$sqlGetWeb = "SELECT * FROM config_settings WHERE CS_type='web'";
...
<html>
    ...
    <body class="">
        ...
        <div id="content"><h3 class="bg-white content-heading border-bottom strong">Web Settings</h3>
    ...
    <script type="text/javascript">
        $("#websettings").addClass("active");
        $("#websettings").parent().parent().addClass("active");
        $("#websettings").parent().addClass("in");
    </script>
