...
$sqlGetWeb = "SELECT * FROM config_settings WHERE CS_type='social'";
...
<html>
    ...
    <body class="">
        ...
        <div id="content"><h3 class="bg-white content-heading border-bottom strong">Social Settings</h3>
    ...
    <script type="text/javascript">
        $("#socialsettings").addClass("active");
        $("#socialsettings").parent().parent().addClass("active");
        $("#socialsettings").parent().addClass("in");
    </script>
