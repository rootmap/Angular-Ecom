...
$sqlGetWeb = "SELECT * FROM config_settings WHERE CS_type='image'";
...
<html>
    ...
    <body class="">
        ...
        <div id="content"><h3 class="bg-white content-heading border-bottom strong">Image Settings</h3>
    ...
    <script type="text/javascript">
        $("#imagesettings").addClass("active");
        $("#imagesettings").parent().parent().addClass("active");
        $("#imagesettings").parent().addClass("in");
    </script>
