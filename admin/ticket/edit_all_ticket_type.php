...
$arr = array();
$get_venues = "SELECT venue_id,venue_title FROM event_venues";
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" id="TT_event_id" name="TT_event_id">
                                            ...
                                            <select class="form-control" id="TT_venue_id" name="TT_venue_id">
                                                ...
                                                <?php if (count($arr) >= 1): ?>
                                                    <?php foreach ($arr as $at): ?>
                                                        <option value="<?php echo $at->venue_id; ?>"  
                                                        <?php
                                                        if ($at->venue_id == $TT_venue_id) {
                                                            echo ' selected="selected"';
                                                        }
                                                        ?>>
                                                            <?php echo $at->venue_title; ?></option>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                            </select>
                                        </div>
