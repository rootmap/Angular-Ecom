...
<html>
    ...
    <body class="">
        ...
        <div id="content"><h3 class="bg-white content-heading border-bottom strong">Delivery Cost For City Event Wise</h3>
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    var dataSource = new kendo.data.DataSource({
                        ...
                        transport: {
                            read: {
                                url: "../controller/city/city_with_delivery_cost.php",
                                type: "GET"
                            },
                            update: {
                                url: "../controller/city/city_with_delivery_cost.php",
                        ...
                        schema: {
                            ...
                            model: {
                                ...
                                fields: {
                                    ...
                                    event_name: {type: "string", validation: {required: true}},
                ...
                function EventFilter(element) {
                    element.kendoDropDownList({
                        ...
                        dataSource: {
                            transport: {
                                read: {
                                    url: "../controller/event/event.php",
                                    type: "GET"
                                }
                            },
                            schema: {
                ...
                function EventDropDownEditor(container, options) {
                    jQuery('<input required data-text-field="event_name" data-value-field="event_id" data-bind="value:' + options.field + '"/>')
                            .appendTo(container)
                            .kendoDropDownList({
                                autoBind: false,
                                dataTextField: "event_name",
    ...
    <script type="text/javascript">
        $("#evdlist").addClass("active");
        $("#evdlist").parent().parent().addClass("active");
        $("#evdlist").parent().addClass("in");
    </script>
