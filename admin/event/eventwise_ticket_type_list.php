            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                    <?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/event/eventwise_ticket_type.php') ?>">
                            <span class="k-icon k-add"></span>
                            Add new Eventwise Ticket Type
                        </a>
                    <?php endif; ?>
                    <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/event/eventwise_ticket_type_list.php'); ?>">
                            <span class="k-icon k-i-arrowhead-w"></span>
                            Go Back Eventwise Ticket Type
                        </a>
                    <?php endif; ?>
                </div>
            </div>
...
<?php if (checkPermission('gallery', 'update', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/event/eventwise_ticket_type.php'); ?>?id=#= id #"><span class="k-icon k-edit"></span>Edit</a>
<?php endif; ?>
                ...
                function deleteClick(imageID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/event/eventwise_ticket_type_controller.php",
                            data: {IG_id: imageID},
                ...
                jQuery(document).ready(function () {
                    ...
                    jQuery("#grid").kendoGrid({
                        ...
                        columns: [
                            ...
                            {field: "ttid", title: "Ticket Type", width: "150px"},
