...
<?php if (checkPermission('venue', 'create', getSession('admin_type'))): ?>
                    <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/venue/event_venue_list_blockbuster_api.php'); ?>?event_id=#= event_id #"><span class="k-icon k-add"></span>Theatre</a>
<?php endif; ?>
<?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>   
                    <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/created_gallery_list.php'); ?>?event_id=#= event_id #"><span class="k-icon k-add"></span>Show Time</a>
<?php endif; ?>
<?php if (checkPermission('event_faq', 'create', getSession('admin_type'))): ?>     
                    <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/event_faq/created_faq_list.php'); ?>?event_id=#= event_id #"><span class="k-icon k-add"></span>Ticket</a>
<?php endif; ?>
            </script>
