...
<html>
    ...
    <body class="">
        ...
        <div id="content">
            <h3 class="bg-white content-heading border-bottom strong">Extra Dynamic Cost List</h3>
            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                    <?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/gallery/movie_terms_and_condition.php') ?>">
                            <span class="k-icon k-add"></span>
                            Add New Movie Terms and condition 
                        </a>
                    <?php endif; ?>
                    <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/event/movie_terms_and_condition_list.php'); ?>">
                            <span class="k-icon k-i-arrowhead-w"></span>
                            Go Back Movie Terms and condition list
                        </a>
                    <?php endif; ?>
                </div>
            </div>
...
<?php if (checkPermission('gallery', 'update', getSession('admin_type'))): ?>
                    <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/gallery/edit_gallery.php'); ?>?event_id=#=id #&image_id=#= id #"><span class="k-icon k-edit"></span>Edit</a>
<?php endif; ?>
                ...
                function deleteClick(imageID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/event/movie_terms_and_condition_controller.php",
                            data: {IG_id: imageID},
