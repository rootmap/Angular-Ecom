                ...
                <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>   
                    <div class="k-toolbar k-grid-toolbar">
                        ...
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/event/index_blockbuster_api.php'); ?>">
                            <span class="k-icon k-add"></span>
                            Add New Movie Event From Blockbuster API
                        </a>
                    </div>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
<?php if (checkPermission('event', 'create', getSession('admin_type'))): ?> 
                    <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/event/similar_event.php'); ?>?event_id=#= event_id #"><span class="k-icon k-add"></span>Similar Event</a>
<?php endif; ?>
            </script>
            <script id="edit_category" type="text/x-kendo-template">
<?php if (checkPermission('event', 'update', getSession('admin_type'))): ?> 
...
<?php endif; ?>   
<?php if (checkPermission('event', 'read', getSession('admin_type'))): ?>   
                    <a target="_blank" class="k-button k-button-icontext k-grid-delete" href="<?php echo baseUrl('details'); ?>/#= event_id #/-" ><span class="k-icon k-search"></span>View</a>
<?php endif; ?>   
            </script>
                ...
                function deleteClick(eventID) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "../controller/event/event_list.php",
