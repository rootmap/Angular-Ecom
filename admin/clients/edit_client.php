...
if (isset($_POST["clients_name"])) {
    ...
    $update_ClientArray .= ', client_phone = "' . $clients_contact_num . '"';
    $update_ClientArray .= ', client_email = "' . $clients_email . '"';
    $update_ClientArray .= ', client_address = "' . $clients_address . '"';
...
if ($countClient > 0) {
    while ($ClientObj = mysqli_fetch_object($resultClient)) {
        ...
        $clients_contact_num = $ClientObj->client_phone;
        $clients_email = $ClientObj->client_email;
        $clients_address = $ClientObj->client_address;
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8"><input class="form-control" id="clients_contact_num" name="clients_contact_num" value="<?php echo $clients_contact_num; ?>" type="text"/></div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Client Email</label>
                                        <div class="col-md-8"><input class="form-control" id="clients_email" name="clients_email" value="<?php echo $clients_email; ?>" type="email"/></div>
                                    </div>
                                    <div class="form-group">
