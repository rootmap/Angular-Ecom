                                    ...
                                    <div class="widget" data-toggle="collapse-widget" data-collapse-closed="true">
                                        ...
                                        <div id="widget<?php echo $permissionID; ?>" class="collapse" style="padding: 15px;">
                                            <ul class="list-regular">
                                                <?php if (count($Permission['privilege']) > 1): ?>
                                                ...
                                                <?php else: ?>
                                                    <li>
                                                        <?php $strModuleAction = $Permission['@attributes']['module'] . "," . $Permission['privilege']['@attributes']['for']; ?>
                                                        <p><input class="check" type="checkbox" name="perm[]" value="<?php echo $Permission['@attributes']['module']; ?>,<?php echo $Permission['privilege']['@attributes']['for']; ?>" <?php
                                                            if (in_array($strModuleAction, $arrCurrentPermission)) {
                                                                echo 'checked="checked"';
                                                            }
                                                            ?>>
                                                            Permission For: <strong><?php echo $Permission['privilege']['@attributes']['description']; ?></strong></p>
                                                    </li>
                                                <?php endif; ?>
                                            </ul>  
                                        </div>
