    ...
    <body class="">
        ...
        <div id="content">
              ...
              <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <div class="k-toolbar k-grid-toolbar">
                    <?php if (checkPermission('gallery', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/contact_us/contact_us.php') ?>">
                            <span class="k-icon k-add"></span>
                            Add New contact Us 
                        </a>
                    <?php endif; ?>
                    <?php if (checkPermission('event', 'create', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/contact_us/contact_us_list.php'); ?>">
                            <span class="k-icon k-i-arrowhead-w"></span>
                            Go Back contact Us  List
                        </a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <?php if (checkPermission('gallery', 'update', getSession('admin_type'))): ?>
                                <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/contact_us/contact_us.php'); ?>?id=#= id #"><span class="k-icon k-edit"></span>Edit</a>
            <?php endif; ?>
