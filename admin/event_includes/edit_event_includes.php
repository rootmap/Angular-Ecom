...
if (isset($_POST['EI_name'])) {
    ...
    $EI_status = mysqli_real_escape_string($con, $EI_status);
    $EI_updated_by = getSession("admin_id");


    $update_IncludesArray = '';
    $update_IncludesArray .= ' EI_event_id = "' . $EI_event_id . '"';
    $update_IncludesArray .= ', EI_venue_id = "' . $EI_venue_id . '"';
    $update_IncludesArray .= ', EI_name = "' . $EI_name . '"';
    $update_IncludesArray .= ', EI_description = "' . $EI_description . '"';
    $update_IncludesArray .= ', EI_price = "' . $EI_price . '"';
    $update_IncludesArray .= ', EI_total_quantity = "' . $EI_total_quantity . '"';
    $update_IncludesArray .= ', EI_limit = "' . $EI_limit . '"';
    $update_IncludesArray .= ', EI_status = "' . $EI_status . '"';
    $update_IncludesArray .= ', EI_updated_by = "' . $EI_updated_by . '"';


    $run_update_query = "UPDATE event_includes SET $update_IncludesArray WHERE EI_id = '$EI_id'";
    ...
    if (!$result) {
        ...
        $msg = "Event Includes updated successfully";
...
//$arr = array();
$includes_sql = "select * from event_includes where EI_id = '$EI_id'";
$includes_result = mysqli_query($con, $includes_sql);

$count_includes = mysqli_num_rows($includes_result);
if ($count_includes > 0) {
    while ($row = mysqli_fetch_object($includes_result)) {
        $EI_venue_id = $row->EI_venue_id;
        $EI_event_id = $row->EI_event_id;
        $EI_name = $row->EI_name;
        $EI_description = $row->EI_description;
        $EI_price = $row->EI_price;
        $EI_total_quantity = $row->EI_total_quantity;
        $EI_limit = $row->EI_limit;
        $EI_status = $row->EI_status;
    }
}
?>
...
<html>
    ...
    <body class="">
        ...
        <div id="content"><h3 class="bg-white content-heading border-bottom strong">Edit Event Includes</h3>
                        ...
                        <div class="widget-body">
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <input class="form-control" id="EI_venue_id" name="EI_venue_id" value="<?php echo $EI_venue_id; ?>" type="hidden"/>
                                    <input class="form-control" id="EI_event_id" name="EI_event_id" value="<?php echo $EI_event_id; ?>" type="hidden"/>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"><input style="width: 200px;" class="form-control" id="EI_price" name="EI_price" min="1" value="<?php echo $EI_price; ?>" type="number"/></div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="totalQuantity">Total Quantity</label>
                                        <div class="col-md-4"><input style="width: 200px;" class="form-control" id="EI_total_quantity" name="EI_total_quantity" min="1" value="<?php echo $EI_total_quantity; ?>" type="number"/></div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="userLimit">Per User Limit</label>
                                        <div class="col-md-4"><input style="width: 200px;" class="form-control" id="EI_limit" name="EI_limit" min="1" value="<?php echo $EI_total_quantity; ?>" type="number"/></div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-4 control-label" style="margin-top: -8px;" for="isActive">Is Active ?</label>
                                        <div class="col-md-4"><input type="checkbox" name="EI_status" id="EI_status" value="active" <?php
                                            if ($EI_status == 'active') {
                            ...
                            <div class="form-actions">
                                <button type="button"  id="btnCreateEventInclude" name="btnCreateEventInclude" class="btn btn-primary" ><i class="fa fa-check-circle"></i> Update Includes</button>
                            </div>
                        </div>
                    </div>
                </form>
