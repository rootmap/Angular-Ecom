            ...
            <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                <?php if (checkPermission('event_includes', 'create', getSession('admin_type'))): ?>
                    <div class="k-toolbar k-grid-toolbar">
                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/event_includes/index.php') ?>">
...
<?php if (checkPermission('event_includes', 'update', getSession('admin_type'))): ?>
                        <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/event_includes/edit_all_event_includes.php'); ?>?EI_id=#= EI_id #"><span class="k-icon k-edit"></span>Edit</a>
<?php endif; ?>   
<?php if (checkPermission('event_includes', 'delete', getSession('admin_type'))): ?>
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    var dataSource = new kendo.data.DataSource({
                        ...
                        transport: {
                            read: {
                                url: "../controller/event_includes/all_event_includes_list.php",
                                type: "GET"
                            },
                            destroy: {
                                url: "../controller/event_includes/all_event_includes_list.php",
