...
if (isset($_GET['event_id'])) {
    $EI_event_id = $_GET['event_id'];
}
if (isset($_GET['venue_id'])) {
    $EI_venue_id = $_GET['venue_id'];
}
...
//    }
    ...
    if (!$result) {
        ...
        $link = "event_includes_list.php?msg=" . base64_encode($msg) . "&" . $_SERVER['QUERY_STRING'];
        redirect($link);
    }
}
?>
...
<html>
    ...
    <body class="">
        ...
        <div id="content"><h3 class="bg-white content-heading border-bottom strong">Add Event Includes</h3>
