            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navigation-index">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li id="location">
                            <a href="#!" data-toggle="modal"  data-target="#myModal" class="btn bxsdw_none btn-location" style="color: #ffffff;">
        ...
        <div class="wrapper">
            ...
            <div class="main">
                        ...
                        <div class="collapse navbar-collapse" id="search-nav">
                            <ul id="homepage-nav-2" class="nav navbar-nav navbar-right" style="margin:0 auto;">
                                ...
                                <li class="text-center single-nav" ng-repeat="x in element| limitTo:4">
                                    <!--<i class="icon-calendar icon-2x nav-icon"></i>-->
                                    <a class="text-primary" href="{{x.category_title| lowercase}}.php?page_id={{x.category_id}}" > {{x.category_title}}</a>
                                </li>
                ...
                <div>
                    ...
                    <div id="hiddenPartOfFeature" style="display:none;">
                    ...
                    <div id="hiddenPartOfPopular" style="display:none;">
                    ...
                    <div id="hiddenPartOfUpcoming" style="display:none;">
