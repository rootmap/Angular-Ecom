...
WHERE a.verified_order_id='" . $order_id . "'  or a.order_id='".$order_id."'";
...
//
//LEFT JOIN (SELECT order_id,order_number,order_total_amount FROM orders) as c on c.order_id=a.verified_order_id WHERE a.order_id='$order_id'";
