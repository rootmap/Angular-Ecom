                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p style="text-align:justify;font:14px Helvetica Neue,Helvetica,Arial,sans-serif;color:#777777;line-height:21px;margin:15px 0 0 0;padding:0">Your password reset process was successful. Please use your new password next on your next login.</p>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
