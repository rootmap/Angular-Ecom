                                    ...
                                    <td height="50">
                                        <table width="500" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="border:1px solid #e3e3e3;padding:0;margin:0">
                                            ...
                                            <tr>
                                                <td height="50">&nbsp;</td>
                                                <td> 
                                                    <p style="font:14px Helvetica Neue,Helvetica,Arial,sans-serif;color:#777777;margin:20px 0 5px 0;padding:0">Your Name:'."$firstName".'</p>
                                                    
                                                    <p style="font:14px Helvetica Neue,Helvetica,Arial,sans-serif;color:#777777;margin:20px 0 5px 0;padding:0">Your Email Address:'."$user_email".'</p>
                                                    
                                                   
                                                    <p style="font:14px Helvetica Neue,Helvetica,Arial,sans-serif;color:#777777;margin:20px 0 5px 0;padding:0">It is recommended to activate your account. Please <b><a href="ticketchai.org/verify_account.php?m=$m & t=$t & ac=$ac" target="blank">click here</a></b> to activate your account.</p>
...
//echo smtpmailer($user_email, 'moindoom@gmail.com', $firstName, 'Account verificaltion',"$html");
