                                ...
                                <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12 col-lg-offset-4 col-md-offset-4">
                                    <form name="myForm">
                                        ...
                                        <div class="form-group text-center">
                                            <button type="button" ng-click="resetPass(info)"  class="btn btn-raised btn-success btn-block btn-login waves-effect" style="border:2px solid#4CAF50;color:#000"><strong>reset</strong></button>
                                            <br/>Return to
