...
echo @$o_id  = $_GET['order_id'];


$orderSql = "SELECT `order_number`, `order_id` FROM `orders` WHERE `order_id` = '$o_id' ORDER BY order_id DESC LIMIT 1";
        ...
        <table border='1' border-collapse: collapse cellspacing='0'  style='margin:0px auto;border:1px solid #81C91B;width:960px; margin: 0 auto;'>
            <tbody>
                <tr>
                    ...
                    <td colspan='2' style='padding-left:1%;border:1px solid #81C91B;'>$o_title
            </td>
            <td rowspan='2' style='text-align: center;padding:1%;border:1px solid #81C91B;'><img style='max-height:80px;max-width:100px' src='../upload/event_web_logo/$event_web_logo' alt='event_logo'></td>
            </tr>
            <tr>
                <td style='padding-left:1%;border:1px solid #81C91B;'>VENUE</td>
                <td colspan='2' style='padding-left:1%;border:1px solid #81C91B;'>
                     $venue_title
                </td>
            ...
            <tr>
                ...
                <td colspan='1' style='padding-left:1%;border:1px solid #81C91B;'>
                     $start_date
                </td>
                <td style='padding-left:1%;border:1px solid #81C91B;'>TIME</td>
                <td style='padding-left:1%;border:1px solid #81C91B;'>Start Time :
                     $start_time &nbsp; End Time:
                         $end_time
                </td>
            </tr>
            <tr>
                ...
                <td style='padding-left:1%;border:1px solid #81C91B;'>
                    $payment_method
                </td>
            ...
            <tr>
                <td colspan='4' style='text-align: center;border:1px solid #81C91B;'>
                    ...
                    <p><img src='http://ticketchai.com/images/ticketchai_logo.png' alt='icketchai Logo' style='max-height:100%;max-width:100%'> </p>
                </td>
            </tr>
...
//echo smtpmailer('mahedi@systechunimax.com', 'moindoom@gmail.com', 'mahedi', 'test',"$html");
