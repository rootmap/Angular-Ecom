...
<head>
    ...
    <?php echo $cms->pageTitle("User_Order | Order_ticket... "); ?>
    <!--Title Part end Here-->
...
<body ng-app="user" ng-controller="orderticketController">
    <!--page loader-->
        <div class="se-pre-con"></div>
        <!--page loader-->
 <span id="trigerl" ng-click="oData1('<?php echo $orderId;?>')"></span>
    <span id="triger" ng-click="oData('<?php echo $orderId;?>')"></span>
    <div class="wrapper">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <!--Box part-->
                            <?php include ('includes/orderTicket_box.php');?>
                            <!--Box part-->
...
<?php echo $cms->footerJs(array("user_order_ticket"));?>
<!-- Footer Js end here--->
