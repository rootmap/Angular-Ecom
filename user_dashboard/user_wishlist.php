...
<head>
    ...
    <?php echo $cms->pageTitle("User_Wishlist | Buy Online Ticket... "); ?>
    <!--Title Part end Here-->
    ...
    <!--CSS Part start here-->
    <?php echo $cms->headCss(array("user_wishlist"));?>
    <!--CSS Part end here-->
</head>

<body ng-app="user" ng-controller="wishlistController">
        <!--page loader-->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <!--Box part-->
                            <?php include ('includes/user_wishlist_box.php');?>
                            <!--Box part-->
...
<?php echo $cms->footerJs(array("user_wishlists"));?>
<!-- Footer Js end here--->
