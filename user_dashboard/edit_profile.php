...
<head>
    ...
    <?php echo $cms->pageTitle("Edit User Profile | Buy Online Ticket... "); ?>
    <!--Title Part end Here-->
...
<body ng-app="user" ng-controller="editProfileController">
    <!--page loader-->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                             ...
                             <!--Box part-->
                            <?php include ('includes/edit_profile_box.php');?>
                            <!--Box part-->
...
<?php echo $cms->footerJs(array("edit_profile"));?>
<!-- Footer Js start here--->
