...
<html lang="en">
    ...
    <head>
        ...
        <style type="text/css">
            ...
            .btn-location:active{color: #FFFFFF !important;}
            .modalsubs .modal-popup-bg {
                background-image: url(./tc-merchant-template/assets/img/sb.jpg);
            ...
            .modalsubs .modal-popup-bg .form-control{
            ...
            .modalsubs .modal-popup-bg .form-control::-webkit-input-placeholder {
                font-size: 16px !important;
                font-weight: bold !important;
                margin-top: 15px !important;
            }
            .modalsubs .modal-popup-bg .form-control:-moz-placeholder { /* older Firefox*/
                font-size: 16px !important;
                font-weight: bold !important;
                margin-top: 15px !important;
            }
            .modalsubs .modal-popup-bg .form-control::-moz-placeholder { /* Firefox 19+ */ 
                font-size: 16px !important;
                font-weight: bold !important;
                margin-top: 15px !important;
            } 
            .modalsubs .modal-popup-bg .form-control:-ms-input-placeholder { 
                font-size: 16px !important;
                font-weight: bold !important;
            ...
            .blur {
                -webkit-filter: blur(5px) grayscale(35%) !important;
            }
            /*.ncdd {color: #000000 !important;}*/
        </style>
    </head>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li id="login">
                            ...
                            if (isset($_SESSION['USER_DASHBOARD_USER_ID'])) {
                                @$user_name = $_SESSION['USER_DASHBOARD_USER_FULLNAME'];
                                echo "<a href='user_dashboard/dashboard.php' class='btn bxsdw_none' style='color: #ffffff;'><i class='fa fa-dashcube'></i> $user_name </a>";
                            } else {
                                echo "";
                            }
                            ?>
                        ...
                        <li id="location">
                            <a href="javascript:void(0);" data-toggle="modal"  data-target="#searchModal" class="btn bxsdw_none btn-location" style="color: #ffffff;">
                                <i class="icon-location icon-2x"></i> <span>{{cityName}}</span>
                            </a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content text-center">
                                        ...
                                        <div class="modal-body">
                                            <h4 class="modal-title" id="searchModalLabel">Cities name</h4>
                                            <hr>
                                            <!--[Select city logic starts]-->
                                            <span ng-if="SearchCityController.length != 0" ng-repeat="s in SearchCityController| filter:searchString ">
                                                <!--                                                <a  href="#hidden" id="selectCityButton" class=" btn btn-danger btn-sm btn-raised margin5 click" ng-click="selectCity(s.city_name);" >
                                                                                                    {{s.city_name}}
                                                                                                </a>-->
                                                <!--<a  href="javascript:void(0);" id="" class=" btn btn-danger btn-sm btn-raised margin5 " ng-click="selectCity(s.city_name);" >-->
                                                <a    href="javascript:void(0);"  class=" btn btn-danger btn-sm btn-raised margin5 " ng-click="eventLoadOnCityName(s.city_name);" >
                                                    {{s.city_name}}
                                                </a>
                                            </span>
                                            <!--[Select city logic ends]-->
                                            <hr>
                                            <!--<a  href="javascript:void(0);" id="" class="btn btn-danger btn-sm btn-raised margin5" ng-click="selectCity(1);">-->
                                            <a href="javascript:void(0);"  class="btn btn-danger btn-sm btn-raised margin5" ng-click="eventLoadOnCityName(1);">
                                                ALL CITIES
                                            </a>
                                        </div> 
                ...
                <div class="crosscover">
                    <div class="crosscover-overlay">
                        <div class="crosscover-island">
                            ...
                            <span class="bold hidden-xs">OR</span>
                            ...
                            <!--[How it works button in slider starts]-->
                            <div class="col-sm-4 col-sm-offset-4" >
                                <a href="<?php echo $cms->baseUrl(" ../howItWorks.php"); ?>" class="btn btn-info btn-raised glow bold">
                                    <strong style="font-size:14px; letter-spacing: 1.2px;">
                                        <i class="fa fa-info-circle" aria-hidden="true"></i> See How Ticketchai Works <i class="fa fa-question" aria-hidden="true"></i>
                                    </strong>
                                </a>
                            </div>
                            <!--[How it works button in slider ends]-->
...
<!--                                <li id="home-nav-search" class="text-center hidden-sm">
                                    <div class="home-search-section col-xs-12">
                                        <div class="form-group has-success">
                                            <input id="home-search" type="text" placeholder="Search for an Event" class="form-control form--inverted" />
                                ...
                                <li id="home-nav-search" class="text-center hidden-sm">
                                    <div class="home-search-section col-xs-12">
                                        <div class="form-group has-success">
                                            <form id="search">
                                                <input name="control" id="home-search" type="text" placeholder="Search for an Event" 
                                                       class="form-control form--inverted control"  ng-model="EventHint" ng-change="searchEvent()">
                                                <span class="form-control-feedback" >
                                        ...
                                        <style type="text/css">
                                            #results li a.active {
                                                background-color: #ffffff !important;
                                                color: #88C659 !important;
                                                border-color: #88C659 !important;
                                            }
                                            
                                            .indexSearchUL{
                                                z-index: 1; position:absolute; margin-top:50px !important; background:#88C659 !important; width:85%; height:auto; color:black; clear: both; border: 1px solid #ffffff;
                                            }
                                        </style>
                                        <!--id = "rslt-div"-->
                                        <div  class="list-group show_hide" style="box-shadow: none; max-width: 190px !important;">
                                            <ul class="indexSearchUL" style="" id="results">

                                                <li class="list-item-sef" tabindex="{{item.tabIndex}}" ng-repeat="x in s = (searchResult| filter: EventHint | limitTo:7 |  orderBy: DESC)" ng-if="EventHint.length > 2">
                                ...
                                <!--                                <li class="text-center single-nav" ng-repeat="x in element| limitTo:5">
                                                                    <a href="{{x.category_title| lowercase}}.php?page_id={{x.category_id}}"><i class="{{x.category_icon}} icon-2x nav-icon"></i> {{x.category_title}}</a>
                                                                </li>
                                ...
                                <li class="dropdown text-center" >
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" id="more">More <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li ng-repeat="x in element.slice(5)"><a href="category.php?cat_id={{x.category_id}};&cat_title={{x.category_title| lowercase}}">{{x.category_title}}</a></li>
                                    </ul>
                                </li>
                ...
                <div id="CitySearchResultPanel" style="display:none;">
                    <!--[Featured events starts]-->
                    <div id="hiddenPartOfFeature" >
                            ...
                            <div class="container">
                                <div class="row section_padd60 ">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section-heading">
                                        <!--<h2><span class="section-topic">Featured</span> Events In <a href="javascript:void(0);" data-toggle="modal"  data-target="#searchModal"><i class="icon-location icon-2x"></i>{{cityName}}</a></h2>-->
                                        <h2><span class="section-topic">Featured</span> Events In {{cityName}}</h2>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section-content section_padd30 animated wow fadeIn" data-wow-duration="1s" >
                                        <div class="card-box col-md-3 col-sm-6 col-xs-12" ng-repeat="fx in featureEventByCity| limitTo : 8 ">
                                            <div class="card">
                                                <div class="header">
                                                    <img class="ch-image" check-image ng-src="./upload/event_web_logo/{{fx.event_web_logo}}" />
                                                    ...
                                                    <div class="actions">
                                                        <a href="checkout1.php?id={{fx.event_id}}" class="btn btn-success btn-raised btn-round">
                                                ...
                                                <div class="content" style="height: 200px !important;">
                                                    ...
                                                    <hr>
                                                    <p class="description">
                                                        <span class="margin5 text-danger bold" ng-hide="fx.venue_title == null"><i class="fa fa-map-marker" aria-hidden="true">&nbsp;</i> {{fx.venue_title}} <span ng-if="fx.city != '' || NULL" style="background: #88C659;padding: 1px;border-radius: 4px;color: #fff;">&nbsp;{{fx.city}}</span></span>
                                                    </p>
                                                    <p class="description">
                                                        <span class="margin5 text-primary bold"><i class="fa fa-calendar" aria-hidden="true">&nbsp;</i> {{fx.venue_start_date}} <span ng-hide="fx.venue_end_date == null">-&nbsp;</span> {{fx.venue_end_date}}</span>
                                                    </p>
                                                    <p class="description">
                                                        <span class="margin5 text-warning bold"><i class="fa fa-clock-o" aria-hidden="true">&nbsp;</i> {{fx.venue_start_time}} <span ng-hide="fx.venue_end_time == null">-&nbsp;</span> {{fx.venue_end_time}}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>

                                        <div  ng-hide="featureEventByCity.length != 0">
                                            <h3>Sorry! No Featured Event Found In {{cityName}}</h3> <br/>
                                            <h3>Stay Tuned For Exciting Events</h3>
                                        </div>
                                    </div>

                                    <div ng-if="featureEventByCity.length > 8" class="col-lg-2 col-md-2 col-sm-4 col-xs-12 col-lg-offset-5 col-md-offset-5 col-sm-offset-4 section-footer text-center section_padd60">
                    ...
                    <div id="hiddenPartOfPopular" >
                        <div class="section section-featured" id="cityPopular">
                            <div class="container">
                                <div class="row section_padd30 ">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section-heading animated wow fadeIn" data-wow-duration="1s" data-wow-delay="0.02s">
                                        <h2><span class="section-topic">Popular</span> Events in {{cityName}}</h2>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section-content section_padd30 animated wow fadeIn" data-wow-duration="1s" >
                                        <div class="card-box col-md-3 col-sm-6 col-xs-12" ng-repeat="x in PopularEventByCity| limitTo:4">
                                        ...
                                        <div  ng-hide="PopularEventByCity.length != 0">
                                            <h3>Sorry! No Popular Event Found In {{cityName}}</h3> <br/>
                                            <h3>Stay Tuned For Exciting Events</h3>
                                        </div>

                                    </div>
                                    <div class="clearfix"></div>
                                    <div ng-if="PopularEventByCity.length > 4" class="col-lg-2 col-md-2 col-sm-4 col-xs-12 col-lg-offset-5 col-md-offset-5 col-sm-offset-4 section-footer text-center section_padd60">
                                        <a href="more_covered_events.php"><button type="button" class="btn btn-block success-rounded-outline waves-effect"><i class="fa fa-arrow-circle-o-down" aria-hidden="true">&nbsp;</i> View More</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="hiddenPartOfUpcoming" >
                        <div class="section section-featured"id="cityUpcoming">
                            <div class="container">
                                <div class="row section_padd30 ">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section-heading animated wow fadeIn" data-wow-duration="1s" data-wow-delay="0.02s">
                                        <h2><span class="section-topic">Upcoming</span> Events in {{cityName}}</h2>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section-content section_padd30 animated wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.02s" id="social-reveal">
                                        <div class="card-box col-md-3 col-sm-6 col-xs-12" ng-repeat="x in UpcomingEventByCity| limitTo:4">
                                            <div class="card collection-card" id="card3" >
                                        ...
                                        <div  ng-hide="UpcomingEventByCity.length != 0">
                                            <h3>Sorry! No Upcoming Event Found In {{cityName}}</h3> <br/>
                                            <h3>Stay Tuned For Exciting Events</h3>
                                        </div>

                                    </div>
                                    <div class="clearfix"></div>
                                    <div ng-if="UpcomingEventByCity.length > 4" class="col-lg-2 col-md-2 col-sm-4 col-xs-12 col-lg-offset-5 col-md-offset-5 col-sm-offset-4 section-footer text-center section_padd60">
                    ...
                    <!--                    <div id="hiddenPartOfCovered" style="display:none;">
                                            <div class="section section-featured">
                                                <div class="container">
                                                    <div class="row section_padd60 ">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section-heading">
                                                            <h2><span class="section-topic">{{covered}}</span> {{events}} in {{cityName}}</h2>
                                                        </div>
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section-content section_padd30 animated wow fadeIn" data-wow-duration="1s" >
                                                            <div class="card-box col-md-3 col-sm-6 col-xs-12" ng-repeat="cx in coveredEventByCity| limitTo:4">
                                                                <div class="card hm-zoom">
                                                                    <div class="view overlay hm-white-slight">
                                                                        <img ng-src="upload/event_web_logo/{{cx.event_web_logo}}" class="img-fluid mdbc-img" alt="">
                                                                        <a>
                                                                            <div class="mask"></div>
                                                                        </a>
                                                                    </div>
                                                                    ...
                                                                    <div class="content" style="height:200px;">
                                                                        ...
                                                                        <a href="checkout1.php?c_id={{cx.event_id}}" class="btn success-rounded-outline btn-block waves-effect">Read More <i class="fa fa-arrow-circle-o-right" aria-hidden="true">&nbsp;</i></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <!--                <li class="animate-repeat" ng-repeat="friend in featuredEvents| filter:q as results">
                                    [{{$index}}] {{friend.event_title}} who is { years old.
                                </li>-->

                <!--[Hidden Core panel ends / Core panel for city wise search ends]-->  
                            ...
                            <div class="row section_padd60 ">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section-content section_padd30 animated wow fadeIn" data-wow-duration="1s" >
                                    <div class="card-box col-md-3 col-sm-6 col-xs-12" ng-repeat="x in featuredEvents| limitTo : 8 ">
                                        <div class="card" ng-init="InitCrtHpST()">
                                            <div class="header">
                                                <!--<img class="ch-image" ng-src="upload/event_web_logo/{{x.event_web_logo}}" />-->
                                                <img class="ch-image" check-image ng-src="./upload/event_web_logo/{{x.event_web_logo}}" />
                                                <!--<div class="filter"></div>-->
                                                <div class="category">
                                                    <span class="category-label label label-info">{{x.event_type_tag}}</span>
                                                ...
                                                <!--<div class="social-line" data-buttons="3">
                                                    <ul  ng-social-buttons  data-title="x.event_title" data-text="x.event_title" data-description="x.event_title" data-image="x.event_web_logo">
                                                        <li class="ng-social-facebook btn btn-social btn-facebook"> <i class="fa fa-facebook-square">&nbsp;</i>{{btn_fb}}</li>
                                                        <li class="ng-social-twitter btn btn-social btn-twitter"><i class="fa fa-twitter-square">&nbsp;</i>{{btn_tw}}</li>
                                                    </ul>
                                                    <!--                                                        <button class="btn btn-social btn-facebook">
                                                                                                                <i class="fa fa-facebook-square">&nbsp;</i>{{btn_fb}}
                                                                                                            </button>-->
                                ...
                                <!--ng-if="featuredEvents.length() > 8"-->
                                <div ng-if="featuredEvents.length > 8"  class="col-lg-2 col-md-2 col-sm-4 col-xs-12 col-lg-offset-5 col-md-offset-5 col-sm-offset-4 section-footer text-center section_padd60">
                                    <a href="more_featured_events.php"><button type="button" class="btn btn-block success-rounded-outline waves-effect"><i class="fa fa-arrow-circle-o-down" aria-hidden="true">&nbsp;</i> {{btn_viewMore}}</button></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="section section-featured">
                        <div class="container">
                            <div class="row section_padd30 ">
                                    ...
                                    <div class="card-box col-md-3 col-sm-6 col-xs-12" ng-repeat="x in coveredEvents| limitTo:4">
                                        <div class="card" ng-init="InitCrtHpST()">
                                            <div class="header">
                                                ...
                                                <!--                                                <div class="social-line" data-buttons="3">
                                                                                                    <ul  ng-social-buttons data-url="'http://ticketchai.com/'" data-title="x.event_title" data-text="x.event_title" data-description="x.event_description" data-image="x.event_web_logo">
                                                                                                        <li class="ng-social-facebook btn btn-social btn-facebook"> <i class="fa fa-facebook-square">&nbsp;</i>{{btn_fb}}</li>
                                                                                                        <li class="ng-social-twitter btn btn-social btn-twitter"><i class="fa fa-twitter-square">&nbsp;</i>{{btn_tw}}</li>
                                                                                                    </ul>
                                                                                                                                                            <button class="btn btn-social btn-facebook">
                                ...
                                <div class="clearfix"></div>
                                <div ng-if="coveredEvents.length > 4" class="col-lg-2 col-md-2 col-sm-4 col-xs-12 col-lg-offset-5 col-md-offset-5 col-sm-offset-4 section-footer text-center section_padd60">
                                    <a href="more_covered_events.php"><button type="button" class="btn btn-block success-rounded-outline waves-effect"><i class="fa fa-arrow-circle-o-down" aria-hidden="true">&nbsp;</i> View More</button></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="section section-featured">
                        <div class="container">
                            <div class="row section_padd30 ">
                                ...
                                <div class="clearfix"></div>
                                <div ng-if="upcomingEvents2.length > 4" class="col-lg-2 col-md-2 col-sm-4 col-xs-12 col-lg-offset-5 col-md-offset-5 col-sm-offset-4 section-footer text-center section_padd60">
                                    <a href="more_upcoming_events.php"><button type="button" class="btn btn-block success-rounded-outline waves-effect"><i class="fa fa-arrow-circle-o-down" aria-hidden="true">&nbsp;</i> View More</button></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row section_padd30 ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section-heading animated wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.02s">
                                <h2>What Our <span class="section-topic">Customers Say</span></h2>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section-content section_padd30">
                                <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                                    ...
                                    <!--                                    <ol class="carousel-indicators hidden-xs animated wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.02s">
                                                                            <li data-target="#quote-carousel" data-slide-to="0" class="active"><img class="img-responsive" src="assets/img/1.jpg" alt=""></li>
                                                                            <li data-target="#quote-carousel" data-slide-to="1"><img class="img-responsive" src="assets/img/avatar.jpg" alt=""></li>
                                                                            <li data-target="#quote-carousel" data-slide-to="2"><img class="img-responsive" src="assets/img/christian.jpg" alt=""></li>
                                                                            <li data-target="#quote-carousel" data-slide-to="2"><img class="img-responsive" src="assets/img/kendall.jpg" alt=""></li>
                                                                            <li data-target="#quote-carousel" data-slide-to="2"><img class="img-responsive" src="assets/img/marc.jpg" alt=""></li>
                                                                        </ol>-->
                                    <ol class="carousel-indicators hidden-xs animated wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.02s" style="top: 150px !important;">
                                        <li data-target="#quote-carousel" data-slide-to="0" class="active" ng-repeat="tes in testimonialController| limitTo : 1"><img class="img-responsive" src="./tc-merchant-template/assets/img/{{tes.photo}}" alt="img1"></li>
                                        <li data-target="#quote-carousel" data-slide-to="1" ng-repeat="tes in testimonialController| limitTo : 10:1"><img class="img-responsive" src="./tc-merchant-template/assets/img/{{tes.photo}}" alt="img2"></li>
                                    ...
                                    <div class="carousel-inner text-center animated wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.02s">
                                        ...
                                        <!-- Quote 1 -->
                                        <!--                                        <div class="item "  ng-repeat="tes in testimonialController| limitTo: 1">
                                                                                    <blockquote>
                                                                                        <div class="row">
                                    ...
                                    <div class="well">
                                        <div id="myCarousel" class="carousel slide">
                                            <div class="carousel-inner">
                                                <div class="item active" >
                                                    <div class="row">
                                                        <div class="col-sm-2 col-xs-6"  ng-repeat="c in clientsController| limitTo : 6"><a href="#x"><img src="./tc-merchant-template/assets/img/clients/{{c.clients_image}}" alt="ClientImage" class="img-responsive"></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="item" >
                                                    <div class="row" >
                                                        <div class="col-sm-2  col-xs-6" ng-repeat="c in clientsController| limitTo : 20 : 6"><a href="#x"><img src="./tc-merchant-template/assets/img/clients/{{c.clients_image}}" alt="ClientImage" class="img-responsive"></a>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <?php include 'include/suscription_modal.php'; ?>
        ...
        <script type="text/javascript">
            ...
            break;
                    ...
                    focusin: function(e) {
                    $(e.currentTarget + ' a').addClass("active");
                    },
                    focusout: function(e) {
                    $(e.currentTarget + ' a').removeClass("active");
                    }
            });
            $("li").first().focus();
        ...
        <script src="angularJs/angular-social-master/sharedirective.js"></script>
        <script src="angularJs/angular-social-master/facebook.js"></script>
