...
<html lang="en">
    ...
    <head>
        ...
        <?php
        echo $cms->pageTitle("Event Detail | Ticketchai.com...");
        ?>
        <?php
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-lg-8 col-md-8 col-sm-8 col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hidden-xs" ng-hide="none">
                                                        <a ng-repeat="tag in tags"href="#"><span class="label label-info"><i class="fa fa-cubes" aria-hidden="true"></i>
                                                                {{tag}}</span>
                                                        </a>
