...
//    WHERE   events.event_status='archived' OR events.event_id IN (SELECT status FROM event_movie_list WHERE `status`='0' GROUP BY movie_id) ORDER BY events.event_featured_priority DESC ";
//                          
