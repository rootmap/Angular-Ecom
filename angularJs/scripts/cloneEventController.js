...
}).controller('cloneEventController', function ($scope, $http, $timeout, growl, listEdit) {
    $scope.list = [];
...
//?? This two function are responsible for load data on display ??
//    event edit  function
    $scope.eventEditFunction = function (eventlist) {
        $http.post("./php/controller/eventListEditController.php", {
            'event_id': eventlist
                                                                ...
                                                                if ($scope.tick_end_date != '') {
                                                                    if ($scope.tick_start_time != '') {
                                                                        if ($scope.tick_end_time != '') {
                                                                            if ($scope.imageOne == null || $scope.imageCover != null || $scope.imageThamb !=null) {
