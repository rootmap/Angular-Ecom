                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div   ng-hide="previewOne" class="col-sm-10 col-sm-offset-1" >
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div ng-hide="previewTwo" class="col-sm-10 col-sm-offset-1">
                        ...
                        <div class="content">
                            <div class="col-sm-6">
                                <a href="javascript:void(0);" class="img-thumbnail">
                                    <img src="assets/img/background/background-2.jpg" alt="img" class="img-responsive" data-toggle="modal" data-target="#myModal">

                                </a>
                            </div>
                            <div class="col-sm-6">
                                <a href="javascript:void(0);" class="img-thumbnail">
                                    <img src="assets/img/background/background-5.png" alt="img" class="img-responsive" data-toggle="modal" data-target="#myModal" >
                                </a>
                            </div>
                            <div class="clearfix"></div>
                        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Select Default Image</h4>
            </div>
            <div class="modal-body">
                <div class="image">
                    <img src="assets/img/background/background-2.jpg" alt="img" class="img-responsive img-thumbnail" style="max-width:185px; max-height:160px">
                    <img src="assets/img/background/background-2.jpg" alt="img" class="img-responsive img-thumbnail" style="max-width:185px; max-height:160px">
                    <img src="assets/img/background/background-2.jpg" alt="img" class="img-responsive img-thumbnail" style="max-width:185px; max-height:160px">
                </div>
            </div>
