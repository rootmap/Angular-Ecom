...
<html lang="en">
    <head>
        ...
        <?php 
        echo $cms->pageTitle("theater | Ticket Chai");
        ?>
    ...
    <body class="index-page signin" ng-app="frontEnd" ng-controller="eventClt"><!--style="background-color: #FFF !important;"-->
        ...
        <div class="wrapper" >
               ...
               <!--  <div class="col-xs-12" style="paddind:150px; ">
                    <h3 style="color:red; font-size:122p">{{msg}}</h3>
                </div> -->
                                    ...
                                    <div class="collapse navbar-collapse" id="search-nav">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <div class="col-md-2 col-sm-12 col-xs-12 text-center">
                                                <li>
                                                    <a href="javascript:void(0)" class="btn btn-nav-search btn-block" data-toggle="modal" data-target="#mySearch_Modal"  ng-click="getEventByKeyword(cID,catId)"><i class="fa fa-search" aria-hidden="true">&nbsp;</i> Search</a>
                                                </li>
                                            </div>
                                        </ul>
                                    </div>
...
<div  style="display: none;" id="mo">
    <div class="section-heading">
        <h2 class="text-fluid">{{title}}</span></h2>      
    </div>
     <div ng-include=" 'more_events.php'"></div>
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="list-group" ng-repeat="x in searchResult| limitTo:5 ">
                            <li class="list-group-item media">
                                <div class="media-left">
                                    <a href="checkout1.php?id={{x.event_id}}">
                                            <img class="media-object img-responsive" src="<?php echo $cms->baseUrl('assets/img/gallery-2/{{x.event_web_logo}}'); ?>" alt="logo_missing" style="display: block; height: 120px; width: 120px;">
                                        </a>
                                </div>
                                <div class="media-body">
                                    <div class="event-title">
