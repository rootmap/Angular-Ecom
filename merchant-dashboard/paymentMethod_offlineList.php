...
<html lang="en">
    ...
    <head>
        ...
        <!--CSS Part start here-->
        <?php echo $cms->headCss(array("paymentMethodOfflinelist")); ?>
        <!--./CSS Part end here-->

    </head>

    <body ng-app="merchantaj" ng-controller="paymentMethodofflineList">
        <!--page loader-->
        ...
        <div class="wrapper">
            ...
            <div class="main-panel">
                ...
                <?php if(!isset($_GET['offpid'])){ ?>
                <span ng-click="loadOffPayList()" id="LoadAllOffpayEvents"></span>
                <?php } ?>
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <!-- Wizard Sarts Here -->
                                 <?php include ('includes/box_paymentMethod_offlineList.php'); ?> 
                                <!--./ Wizard Ends Here -->
                            </div>
                        </div>
                    </div>
    ...
    <?php
    echo $cms->footerJs(array("paymentMethodOfflinelist"));
    ?>
