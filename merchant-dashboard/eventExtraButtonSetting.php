...
<html lang="en">
    ...
    <head>
        ...
        <!--CSS Part start here-->
        <?php echo $cms->headCss(array("eventButtonList")); ?>
        <!--./CSS Part end here-->

    </head>

    <body ng-app="merchantaj" ng-controller="eventButtonListController">
        <!--page loader-->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <!-- Wizard Sarts Here -->
                                <?php include ('includes/box_event_button_List.php'); ?> 
                                <!--./ Wizard Ends Here -->
                            </div>
                        </div>
                    </div>
    ...
    <?php
    echo $cms->footerJs(array("eventButtonList"));
    ?>
   <script>
