...
<html lang="en">
    ...
    <head>
        ...
        <?php echo $cms->pageTitle("Payment Method| Buy Online Ticket... "); ?>
        <!--./Title Part end Here-->
        ...
        <!--CSS Part start here-->
        <?php echo $cms->headCss(array("paymentMethodOffline")); ?>
        <!--./CSS Part end here-->

    </head>

    <body ng-app="merchantaj" ng-controller="paymentMethodOffline">
        <!--page loader-->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <?php if(isset($_GET['pid'])){ 
                                $pid=$_GET['pid'];
                                ?>
                            <span id="LoadEditoffData" ng-click="loadPaymentmethodofflineEdit('<?php echo $_GET['pid']; ?>')"></span>
                                <?php
                            }else{ $pid=0;  } ?>
                            
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <!-- Wizard Sarts Here -->
                                 <?php include ('includes/box_paymentMethodoffline.php'); ?> 
                                <!--./ Wizard Ends Here -->
                            </div>
                        </div>
                    </div>
    ...
    <?php
    echo $cms->footerJs(array("paymentMethodOffline"));
    ?>
    <?php 
                if(isset($_GET['pid']))
                {
