...
<?php 
$evt_desc='';
$sqlEX="SELECT event_description FROM events WHERE event_id='".$_GET['eid']."'";
$sqlExData=mysqli_query($con,$sqlEX);
$sqlExCheck=mysqli_num_rows($sqlExData);
if($sqlExCheck!=0)
{
    $Exdata=mysqli_fetch_array($sqlExData);
    $evt_desc .=$Exdata['event_description'];
}
?>
<div class="card padding_top15">

    <div class="header">
        <h4 class="title"><span class="fa fa-clone"></span> Edit Event </h4>
        <hr>
    </div>
    <div class="content"> 
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12" >
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-addon" id="basic-addon3">http://www.ticketchai.com/event/</span>
                                <input type="text" ng-init="createNewEvtLinkCus(evt)" class="form-control"  id="basic-url" aria-describedby="basic-addon3" ng-model="evt.EventURL">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input id="stime" ng-model="evt.StartTime" name="evt_start_time"  ng-init="InitTime()" type="text" class="form-control timepicker" placeholder="Time Picker Here"/>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input id="etime" ng-model="evt.EndTime" name="evt_end_time"  ng-init="InitTime()" type="text" class="form-control timepicker" placeholder="Time Picker Here"/>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <fieldset id="venue_detail">
                        <div class="col-md-5">
                            ...
                            <div class="form-group" >
                                ...
                                <input ng-model="evt.ven_address" type="text" class="form-control" id="street_number" placeholder="Street Line 1">
                            </div>
                            <div class="form-group">
                                <label for="3">Address Line 2</label>
                                <input ng-model="evt.ven_addresss" type="text"  class="form-control" id="route"  placeholder="Street Line 2">
                            </div>
                            <div class="form-group">
                                <label for="4">City</label>
                                <input ng-model="evt.ven_city" type="text"   class="form-control" id="locality"   placeholder="City">
                            </div>
                            <div class="form-group">
                                <label for="5">Country</label>
                                <input ng-model="evt.ven_country" type="text"class="form-control" id="country"   placeholder="Country">
                            </div>
                            <div class="form-group">
                                <label for="1">ZIP/Postal Code</label>
                                <input ng-model="evt.ven_zip" type="text" class="form-control" id="postal_code" placeholder="Name of Venue" required>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select ng-readonly="ckt.tick_type == 2"  ng-model="ckt.tick_currency" class="form-control">
                                            ...
                                            <option ng-repeat="ect in LoadCurrency"
                                              ng-selected="'{{ckt.tick_currency}}'=='{{ect.id}}'"  value="{{ect.id}}">{{ect.name}}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div ng-if="ckt.tick_availability == 1" class="btn-group" data-toggle="buttons" role="group" aria-label="...">
                                            
                                            <label class="btn btn-success active" ng-click="ckt.tick_availability = 1">
                                        ...
                                        <div ng-if="ckt.tick_availability == 2" class="btn-group" data-toggle="buttons" role="group" aria-label="...">
                                            ...
                                            <label class="btn btn-success active" ng-click="ckt.tick_availability = 2">
                                                <input    type="radio" name="options" id="option2" value="halt">
                                                Halt <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                            </label>
                                        ...
                                        <div ng-if="ckt.tick_availability == 3" class="btn-group" data-toggle="buttons" role="group" aria-label="...">
                                            ...
                                            <label class="btn btn-success active" ng-click="ckt.tick_availability = 3">
                                                <input    type="radio" name="options" id="option3" value="hidden">
                                                Hidden <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                            </label>
                                        ...
                                        <div ng-if="ckt.tick_availability == 0" class="btn-group" data-toggle="buttons" role="group" aria-label="...">
                                ...
                                <div class="col-md-6" ng-hide="ckt.tick_type == 2">
                                    <div class="form-group">
                                        ...
                                        <div class="btn-group" data-toggle="buttons" role="group" aria-label="...">
                                            ...
                                            <label ng-if="ckt.tick_fee_from == 1" class="btn btn-success active"   ng-click="ckt.tick_fee_from = 1">
                                                <input type="radio" name="options2" id="options1" value="me" checked="checked" />
                                                Me <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                            </label>

                                            <label ng-show="ckt.tick_fee_from == 2" class="btn btn-success"   ng-click="ckt.tick_fee_from = 1">
                                                <input type="radio" name="options2" id="options1" value="me" checked="checked" />
                                                Me <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                            </label>

                                            <label  ng-show="ckt.tick_fee_from == 1" class="btn btn-success" ng-click="ckt.tick_fee_from = 2">
                                                <input type="radio" name="options2" id="options2" value="customer">
                                                Customer <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                            </label>
                                            <label ng-if="ckt.tick_fee_from == 2" class="btn btn-success active" ng-click="ckt.tick_fee_from = 2">
                                                <input type="radio" name="options2" id="options2" value="customer">
                                                Customer <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                            </label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input  name="tick_start_date" ng-model="ckt.tick_start_date"  id="{{$index}}" value="{{ckt.tick_start_date}}" ng-init="InitDateTicket()"  type="text" class="form-control datepickerT"  placeholder="Date Picker Here"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Sales start Time</label>
                                        <input   name="tick_start_time"  ng-model="ckt.tick_start_time" id="{{$index}}" ng-init="InitTimeTicket()"  type="text" class="form-control timepickerT"  placeholder="Time Picker Here"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Sales end Date </label>
                                        <input  name="tick_end_date"  ng-model="ckt.tick_end_date" id="{{$index}}" ng-init="InitDateTicket()" type="text" class="form-control datepickerT"  placeholder="Date Picker Here"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input  name="tick_end_time"  ng-model="ckt.tick_end_time" id="{{$index}}" ng-init="InitTimeTicket()" type="text" class="form-control timepickerT"   placeholder="Time Picker Here"/>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  rows="3" id="tick_desc"  ng-model="ckt.tick_evt_des"  placeholder="ex:This Ticket Includes Lunnch" class="form-control"></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  id="tick_mess_atten" rows="3"  ng-model="ckt.tick_evt_messatten"  placeholder="ex:Please Reach The Venue 15 Minutes Before The Show Start Time" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                        <textarea ui-tinymce="tinymceOptions" ng-model="evt.evt_desc"></textarea>
                            <!-- <label for="1">Event Description</label>'<?php // $evt_desc?>' -->
                            <textarea ng-hide="true" ng-model="evt.evt_desc" id="evt_desc"  style="height: 200px;" placeholder="Type Your Event Description Here" class="form-control"></textarea>
<!--<textarea ng-model="evt.evt_desc" rows="3" placeholder="Type Your Event Description Here" class="form-control"></textarea>-->
                    ...
                    <div class="col-md-12" style="margin-top: 30px;">
                        ...
                        <legend><span class="ti-receipt"></span><label for="event-name">Event Terms and Conditions</label><span>&emsp;<input type="checkbox" name="checkfield" id="terms" onclick="ShowHideDiv(this)" /></span></legend>
                    </div>
                    <div class="col-lg-12" id="e_terms">
                        <div class="form-group">
                            <textarea style="display:none;" ng-model="evt.evt_terms" id="evt_terms" placeholder="Type Your Event Terms and Conditions Here" class="form-control"></textarea>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div style=" background-color: #f1f8e9;border: 1px solid #82bd55;  border-radius: 4px;padding: 5px 5px">
                            ...
                            <a href="javascript:void(0)"  ng-click="addToList(todo)" class="ti-plus" ></a> <input type="text" ng-model="todo" ng-keyup="$event.which === 13 || $event.keyCode == 32 ? addToList(todo) : null" id="todo" style=" background-color: #f1f8e9;border: 1px solid #82bd55;  width:20%;padding: 5px 5px"> 
                        </div>
                    </div>

                    <div class="col-md-12 h" style="margin-top: 30px;">
                        <legend><span class="ti-receipt"></span>Online Payment Setting </legend>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select ng-model="evt.evt_btn_lbl" class="form-control " data-title="Single Select" data-style="btn-success btn-block">
                                ...
                                <option ng-repeat="eb in LoadEventButton"  ng-selected="{{evt.evt_btn_lbl}}=={{eb.id}}" value="{{eb.id}}">{{eb.name}}</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div id="hideMe" style="display:block"> 
                                <div  style="display: block;" class="col-sm-12">
                                    <img ng-src=".././upload/event_web_banner/{{evt.banner}}" class="img-thumbnail img-responsive" style="height: 180px; width: 100%;"   />
                                    <a  id="hBtn" ng-click="clearOldBanner()" class="label label-danger" style="position: absolute; left:13px; bottom:-23px; z-index: 9999; height:auto;  width: auto;"><i class="fa fa-close"></i> Remove</a>
                                </div>
                                <span ng-model="evt.banner"></span> 
                            </div>    
                            <!--front Panel-->
                            ...
                            <div id="back" style="display:none;">
                                    <!--panel two-->
                                    <div ng-model="evt.evt_desc" ng-show="previewOneDefault" style="display: block;" class="col-sm-12">
                                        <img src=".././upload/event_default_images/{{imageCover}}" class="img-thumbnail img-responsive" style="height: 180px; width: 100%;"/>
                                    ...
                                    <div  ng-show="previewOne" style="display: block;" class="col-sm-12">
                                    ...
                                    <div ng-hide="previewOne" class="col-sm-12 previewOne" >
                                        <form method="post" enctype="multipart/form-data" id="event-cover-photo">
                                            <div  style="height: 180px; width: 100%;" data-image-type="cover" 
                                                  data-image="" data-resize="true" data-canvas="true" 
                                                  data-ajax="false" data-ghost="false" data-originalsize="false" 
                                                  data-height="340" data-width="1350" 
                                                  class="dropzone event-photo event-photo-cover text-center hidden-xs" 
                                                  id="cover-photo">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div id="logohideMe" style="display:block"> 
                                <div  style="display: block;" class="col-sm-12">
                                    <img ng-src=".././upload/event_web_logo/{{evt.logo}}" class="img-thumbnail img-responsive" style="height: 180px; width: 100%;" />
                                    <a  id="hBtn" ng-click="clearOldLogo()" class="label label-danger" style="position: absolute; left:13px; bottom:-23px; z-index: 9999; height:auto;  width: auto;"><i class="fa fa-close"></i> Remove</a>
                                </div>
                                <span ng-model="evt.logo"></span>
                            </div>    
        ...
        <div class="col-md-12" style="margin-top: 30px;">
            <button type="button" ng-click="createEventJourney(evt, 'upcoming', 'btn_normal',<?php echo $eid ;?>); myFunction()" class="btn btn-success btn-fill"><span class="ti-save"></span> SAVE & EXIT </button>
            <button type="button" ng-click="createEventJourney(evt, 'pending', 'btn_preview',<?php echo $eid ;?>)" data-toggle="modal" data-target="preview" class="btn btn-success btn-fill"><span class="ti-eye"></span> PREVIEW </button>
            <button type="button" ng-click="createEventJourney(evt, 'active', 'btn_normal',<?php echo $eid ;?>)" class="btn btn-success btn-fill"><span class="ti-new-window"></span> GO LIVE </button>
        </div>
...
<!--<p>Event Tags: {{tag}}</p>-->
                ...
                <button type="button" ng-click="createEventJourney(evt, 'pending',<?php echo $eid ;?>)" class="btn btn-success btn-fill"><span class="ti-new-window"></span> CONTINUE</
