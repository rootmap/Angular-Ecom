...
<div class="card padding_top15">
    ...
    <div class="header">
        <h4 class="title"><span class="fa fa-clone"></span> Clone Event </h4>
        <hr>
    </div>
    <div class="content"> 
        <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <?php 
                         ...
                         ?>
                            ...
                            <textarea ng-model="evt.evt_desc='<?=$evt_desc?>'" id="evt_desc"  style="height: 200px;" placeholder="Type Your Event Description Here" class="form-control"></textarea>
