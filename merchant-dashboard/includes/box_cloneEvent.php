...
<div class="card padding_top15">
    ...
    <div class="header">
        <h4 class="title"><span class="ti-pencil-alt"></span> Clone Event</h4>
        <hr>
    </div>
    <div class="content"> 
        <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input name="evt_start_time" ng-model="evt.StartTime"  ng-init="InitTime()" type="text" class="form-control timepicker" placeholder="Time Picker Here"/>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input name="evt_end_time" ng-model="evt.EndTime"  ng-init="InitTime()" type="text" class="form-control timepicker" placeholder="Time Picker Here"/>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea ng-hide="true" ng-model="evt.evt_desc" id="evt_desc" placeholder="Type Your Event Description Here" class="form-control"></textarea>
