...
<html lang="en">
    ...
    <head>
        ...
        <?php
        echo $cms->pageTitle("Pick Point | Buy Online Ticket...");
        ?>
        <!--./Title Part end Here-->
        ...
        <!--CSS Part start here-->
        <?php
        echo $cms->headCss(array("pickpointlist"));
        ?>
        <!--./CSS Part end here-->

    </head>

    <body ng-app="merchantaj" ng-controller="pickpointlistController">
        <!--page loader-->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <!-- Wizard Sarts Here -->
                                <?php include ('includes/box_pick_point_list.php'); ?> 
                                <!--./ Wizard Ends Here -->
                            </div>
                        </div>
                    </div>
    ...
    <?php
    echo $cms->footerJs(array("pickpointlist"));
    ?>
    <!--Footer Js End Here-->
