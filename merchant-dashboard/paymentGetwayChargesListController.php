...
<html lang="en">
    ...
    <head>
        ...
        <?php echo $cms->pageTitle("PAYMENT GETWAY CHARGE | Ticketchai"); ?>
        <!--./Title Part end Here-->
        ...
        <!--CSS Part start here-->
        <?php echo $cms->headCss(array("paymentGetwayCharges")); ?>
        <!--./CSS Part end here-->

    </head>

    <body ng-app="merchantaj" ng-controller="paymentGetwayChargesController">
        <!--page loader-->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <!-- Wizard Sarts Here -->
                                <?php include ('includes/box_payment_gateway_charges_list.php'); ?> 
                                <!--./ Wizard Ends Here -->
                            </div>
                        </div>
                    </div>
    ...
    <?php
    echo $cms->footerJs(array("paymentGetwayCharges"));
    ?>
   <script>
