...
if (!empty($id)) {
    ...
    if ($executeUserInfo) {
        ...
        if (isset($getUserInfo->user_id)) {
            ...
            $sub = 'User Account Creation Complete By Ticketchai Order System';
                            ...
                            <tr>
                                <td valign="top">
                                    ...
                                    <p style="font-weight:bold; font-size:12px; color:#202120;line-height:25px">
                                        ...
                                        <br/> If you have any questions about your signup please contact us at <a style="color:#1e7ec8" href="mailto:support@ticketchai.com" target="_blank">support@ticketchai.com</a> or call us at <span class="m_3400397995181562166m_8401342642413116184m_-1842238349812301262nobr"> +88 01971-Ticket (842538), <a href="tel:+880%201942-999666" value="+8801942999666" target="_blank">+8801942 999666</a>  </span> Every Sat To Thurs, <span class="aBn" data-term="goog_5961152" tabindex="0"><span class="aQJ">10am - 6pm</span></span> BDT.
                                    </p>
                                    <br>
                                    <p style="font-weight:bold; font-size:16px; color:#4585F3;line-height:25px">Your user account is created automatically by Ticketchai Order System. </p>
                                    <p style="font-weight:bold; font-size:13px; color:#4CAF50;line-height:25px">You can use these credentials given below for signing in to ticketchai User Dashboard. </p>
                                </td>
                            </tr>

                            <h4 style="background:#ccc; padding:5px; border-radius:5px;" align="center">Informations used to create your account.</h4>
                                            ...
                                            <tr>
                                                <td style="font-size:12px;padding:7px 9px 9px 9px;border-left:1px solid #eaeaea;border-bottom:1px solid #eaeaea;border-right:1px solid #eaeaea" valign="top">
                                                    <span style="font-weight:bold; font-size:16px; color:#4585F3;line-height:30px; padding: 5px;">
                                                            ...
                                                            Name:</span> <span style="font-size: 13px; font-weight: bold;">' . $firstName . ' '.$lastName.'</span>
                                                    <br>
                                                    <span style="font-weight:bold; font-size:16px; color:#4585F3;line-height:30px; padding: 5px;">
                                                            ...
                                                            Email:</span> <span style="font-size: 13px; font-weight: bold;">' . "$user_email" . '</span>
                                                    <br>
                                                    <span style="font-weight:bold; font-size:16px; color:#4585F3;line-height:30px; padding: 5px;">
                                                    ...
                                                    <span style="font-weight:bold; font-size:16px; color:#4585F3;line-height:30px; padding: 5px;">
                                                            ...
                                                            Password:</span> <span style="font-size: 13px; font-weight: bold;">' . "$userPass" . ' </span>
                                                </td>
                                            </tr>
