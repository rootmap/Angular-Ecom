...
while ($rowevent = mysqli_fetch_array($resultevent)) {
    ...
    $EventVenue = $rowevent['venue_title'].', '.$rowevent['city'].', '.$rowevent['country'];
}

$sub = 'Your event '.$EventName.' created successfully';
                                    ...
                                    <td height="50">
                                        <table width="650" cellspacing="0" cellpadding="10" border="0" bgcolor="#FFFFFF" style="border:1px solid #88C659; border-radius: 4px; font-family:arial; padding:0;margin:0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="3"  style="font-weight:bold; font-size:18px; color:#4585F3;line-height:25px; text-align:center"><h3>Event Details</h3></td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                        ...
                                                        <p  style="font-weight:bold; font-size:16px; color:#607D8B;line-height:25px; text-align: justify;">
                                                            We would like to inform you that, the event registered on our portal http://www.ticketchai.com/ has been published.
                                                        </p>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="font-size:12px;padding:7px 9px 9px 9px;" valign="top">
                                                                        ...
                                                                        <span style="font-weight:bold; font-size:16px; color:#4585F3;line-height:30px; padding: 5px;">
                                                                            Event URL:</span> http://ticketchai.com/ticketchaiorg/checkout1.php?id='.$event_id.'<br>
                                                                        <span style="font-weight:bold; font-size:16px; color:#4585F3;line-height:30px; padding: 5px;">
                                                                            Event Venue:</span> ' . "$EventVenue" . '
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
...
// smtpmailer('to@gmail.com', 'from@gmail.com', $name, $sub,"$html");
 ...
 smtpmailer($email, 'support@ticketchai.com', $name, $sub,$html);
