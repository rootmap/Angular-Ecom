...
if ($socialst == 1) {
    $sub = 'Merchant login using ' . $type;
} else {
    $sub = 'Merchant Account Creation Complete';
}
//$msg = $data->msg;
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td valign="top">
                                        ...
                                        <br>
                                        <p style="font-weight:bold; font-size:16px; color:#4585F3;line-height:25px">Your account is created successfully, now you create your own event, manage your ticket, select your payment api, and also you can manage your orders. </p>
                                    </td>
                                </tr>
                                                ...
                                                <tr>
                                                    <td style="font-size:12px;padding:7px 9px 9px 9px;border-left:1px solid #eaeaea;border-bottom:1px solid #eaeaea;border-right:1px solid #eaeaea" valign="top">
                                                        ...
                                                        <span style="font-weight:bold; font-size:16px; color:#4585F3;line-height:30px; padding: 5px;">
                                                            ...
                                                            Phone:</span> <span style="font-size: 13px; font-weight: bold;">' . "$phone" . '</span><br>
                                                        <span style="font-weight:bold; font-size:16px; color:#4585F3;line-height:30px; padding: 5px;">
