...
<html lang="en">
    ...
    <head>
        ...
        <?php
        echo $cms->pageTitle("Event Button List | Buy Online Ticket...");
        ?>
        <!--./Title Part end Here-->
        ...
        <!--CSS Part start here-->
        <?php
        echo $cms->headCss(array("eventButton"));
        ?>
        <!--./CSS Part end here-->

    </head>

    <body ng-app="merchantaj" ng-controller="eventButtonlistShowController">
        <!--page loader-->
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <!-- Wizard Sarts Here -->
                            <?php include ('includes/box_event_button_show_list.php'); ?> 
                            <!--./ Wizard Ends Here -->
                        </div>
                    </div>
                </div>
...
<?php
echo $cms->footerJs(array("eventButton"));
?>
<!--Footer Js End Here-->
