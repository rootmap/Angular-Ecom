...
<html lang="en">
    ...
    <head>
        ...
        <?php echo $cms->pageTitle("Change Event Status| Buy Online Ticket... "); ?>
        <!--./Title Part end Here-->
        ...
        <!--CSS Part start here-->
        <?php echo $cms->headCss(array("changeEventStatus")); ?>
        <!--./CSS Part end here-->

    </head>

    <body id="venueAllData" ng-app="merchantaj" ng-controller="changeEventStatusController" ng-model="venueAllData">
        <!--page loader-->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <!-- Wizard Sarts Here -->
                                <?php include ('includes/box_change_event_status.php'); ?> 
                                <!--./ Wizard Ends Here -->
                            </div>
                        </div>
                    </div>
    ...
    <?php
    echo $cms->footerJs(array("changeEventStatus"));
    ?>
