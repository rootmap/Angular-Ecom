...
<html lang="en">
    ...
    <head>
        ...
        <?php
        echo $cms->pageTitle("Manual New Pick Point | Buy Online Ticket...");
        ?>
        <!--./Title Part end Here-->
        ...
        <!--CSS Part start here-->
        <?php
        echo $cms->headCss(array("manualNewPickPoint"));
        ?>
        <!--./CSS Part end here-->

    </head>

    <body ng-app="merchantaj" ng-controller="manualNewPickPointController">
        <!--page loader-->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <!-- Wizard Sarts Here -->
                                <?php include ('includes/box_manualNew_pick_point.php'); ?> 
                                <!--./ Wizard Ends Here -->
                            </div>
                        </div>
                    </div>
    ...
    <?php
    echo $cms->footerJs(array("manualNewPickPoint"));
    ?>
    <!--Footer Js End Here-->
