...
<html lang="en">
    ...
    <head>
        ...
        <?php echo $cms->pageTitle("Partners logo Upload | Buy Online Ticket... "); ?>
        <!--./Title Part end Here-->
    ...
    <body ng-app="merchantaj" ng-controller="partnersImgController">
        <!--page loader-->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <!-- Wizard Sarts Here -->
                                 <?php include ('includes/box_partnersImg.php'); ?> 
                                <!--./ Wizard Ends Here -->
                            </div>
                        </div>
                    </div>
    ...
    <?php
    echo $cms->footerJs(array("partnersImg"));
    ?>
    <?php 
                if(isset($_GET['tid']))
                {
