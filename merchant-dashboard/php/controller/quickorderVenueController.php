...
$customerFirstName ="supporter";
$customerLastName = "ticketchai";
$customerPhone ="01920010101";
$customerEmail = "supporter@ticketchai.com";
$hmDelivery ="instant";
//order
...
if ($chkuser == 0) {
    ...
    $sql = "INSERT INTO users SET  user_first_name='$customerFirstName',user_last_name='$customerLastName', user_email='$customerEmail',user_phone='$customerPhone',user_delivery_address='$hmDelivery'";
...
//ORDER INSERT FUNCTION START  HERE
    $orderSql = "INSERT INTO  orders SET order_user_id='$user_id',order_created='$ordercreated',order_read='no',order_number='[".date('dmy')."]-".$loid."',order_status='booking',order_payment_type='Card',order_method='delivery',order_total_item='$ticketQuantity',order_total_amount='100',order_session_id='$sessionId'";
