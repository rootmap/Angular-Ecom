...
WHERE 
(DATE_FORMAT(`event_created_on`,'%m/%d/%Y') BETWEEN '$modelDateStart' AND '$modelDateEnd') OR (DATE_FORMAT(`event_created_end`,'%m/%d/%Y') BETWEEN '$modelDateStart' AND '$modelDateEnd') AND `event_created_by`='$login_user_id' AND event_status='active'
