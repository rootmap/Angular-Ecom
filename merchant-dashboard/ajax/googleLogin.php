    ...
    function loginCallback(result)
    {
        if (result['status']['signed_in'])
        {
            ...
            request.execute(function (resp)
            {
                ...
                var data = new Object();
                data.admin_first_name = resp['name']['givenName'];
                data.admin_last_name = resp['name']['familyName'];
                data.admin_email = email;
                data.admin_social_id = resp['id'];
                data.admin_gender = resp['gender'];
                data.admin_social_types = 'google';
