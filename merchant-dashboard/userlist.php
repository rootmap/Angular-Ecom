...
<html lang="en">
    ...
    <head>
        ...
        <?php echo $cms->pageTitle("User  List| Buy Online Ticket... "); ?>
        <!--./Title Part end Here-->
        ...
        <!--CSS Part start here-->
        <?php echo $cms->headCss(array("userlist")); ?>
        <!--./CSS Part end here-->

    </head>

    <body ng-app="merchantaj" ng-controller="userListController">
        <!--page loader-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><legend><span class="ti-timer"></span> User Date And Time</legend></h4>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <!-- Wizard Sarts Here -->
                                 <?php include ('includes/box_userList.php'); ?> 
                                <!--./ Wizard Ends Here -->
                            </div>
                        </div>
                    </div>
    ...
    <?php
    echo $cms->footerJs(array("userlist"));
    ?>
     <script>
    // Init DatetimePicker
