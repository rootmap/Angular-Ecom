				...
				if (value !='' && skipTag != true) {
                    ...
                    $('<span>').addClass('tag').append(
                        ...
                        $('<a class="tagsinput-remove-link">', {
                            ...
                            angular.element(document.getElementById('evt')).scope().removetagfrmar(escape(value));
                            return $('#' + id).removeTag(escape(value));
                        })
                    ).insertBefore('#' + id + '_addTag');
                                        angular.element(document.getElementById('evt')).scope().eventtag(value);
					tagslist.push(value);
					...
					if (jQuery.Autocompleter !== undefined) {
						...
						$(data.fake_input).bind('blur',data,function(event) {
							...
							return false;
                                ...
                                //$(data.fake_input).attr("ng-model","tag");
                                //$(data.fake_input).attr("ng-keypress","($event.which === 13)?eventtag(tag):0");
