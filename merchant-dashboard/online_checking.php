...
<html lang="en">
    ...
    <head>
        ...
        <?php echo $cms->pageTitle("Verify Barcode From Ticket| Ticketchai.com "); ?>
        <!--./Title Part end Here-->
        ...
        <!--CSS Part start here-->
        <?php echo $cms->headCss(array("onlineChecking")); ?>
        <!--./CSS Part end here-->

    </head>

    <body ng-app="merchantaj" ng-controller="onlineCheckingController">
        <!--page loader-->
        ...
        <div class="wrapper">
            ...
            <div class="main-panel">
                ...
                <span ng-click="loadonlineList()" id="LoadAllonline"></span>
                <?php } ?>
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <!-- Wizard Sarts Here -->
                                 <?php include ('includes/box_online_checking.php'); ?> 
                                <!--./ Wizard Ends Here -->
                            </div>
                        </div>
                    </div>
    ...
    <?php
    echo $cms->footerJs(array("onlineChecking"));
    ?>
